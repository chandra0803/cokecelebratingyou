...
<html:form styleId="contentForm" action="claimFormStepElementUpdate">
  ...
  <table border="0" cellpadding="10" cellspacing="0" width="100%">
    <tr>
      <td>
        <span class="headline"><cms:contentTemplateText key="UPDATE_HEADER" code="claims.form.step.element" args="${claimFormStepElementForm.claimFormStepElementTypeDesc}" /></span>

        <%--INSTRUCTIONS--%>
        <br/><br/>
        <span class="content-instruction">
          <cms:contentText key="UPDATE_INFO" code="claims.form.step.element"/>
        </span>
        <br/><br/>
        <%--END INSTRUCTIONS--%>
        ...
        <table>
          ...
          <c:forEach items="${elementItems}" var="item">
            ...
            <c:otherwise>
            <tr>
              <beacon:label property="${item.formProperty}" required="true">
              ...
              <td class="content-field">
                ...
                <c:if test="${item.numberField}"><html:text property="${item.formProperty}" maxlength="10" /></c:if>
          ...
          <tr class="form-buttonrow">
            ...
            <td align="left">
              <beacon:authorize ifNotGranted="LOGIN_AS">
			        <html:submit styleClass="content-buttonstyle" onclick="maintainClaimFormStepElement('update')">
