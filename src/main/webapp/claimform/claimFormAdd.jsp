...
<html:form styleId="contentForm" action="claimFormMaintainCreate">
  ...
  <table border="0" cellpadding="10" cellspacing="0" width="100%">
    <tr>
      <td>
        <span class="headline"><cms:contentText key="ADD_HEADER" code="claims.form.details"/></span>

        <%--INSTRUCTIONS--%>
        <br/><br/>
        <span class="content-instruction">
          <cms:contentText key="ADD_INFO" code="claims.form.details"/>
        </span>
        <br/><br/>
        <%--END INSTRUCTIONS--%>
        ...
        <table>
	        <tr>
            <beacon:label property="formName" required="true">
