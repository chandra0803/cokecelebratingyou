...
<c:forEach
	items="${listBuilderForm.excludeNodeTypeCharacteristicValueList}"
	...
	<%--
              ...
              the excludeNodeTypeCharacteristicValueInfo bean to the valueInfo bean. Is there a tag way to do this rather than
              using a scriptlet?
              --%>
	<% pageContext.setAttribute( "excludeNodeTypeCharacteristicValueInfo", pageContext.getAttribute( "valueInfo" ) ); %>
