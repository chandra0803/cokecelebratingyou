...
<!--
function maintainUserAddress( method, action )
{
	document.userAddressForm.method.value=method;	
	document.userAddressForm.action = action;
	document.userAddressForm.submit();
}
//-->
</script>
<html:form styleId="contentForm" action="userAddressMaintainCreate">
  ...
  <table border="0" cellpadding="10" cellspacing="0" width="100%">
    <tr>
      <td>
        <span class="headline"><cms:contentText key="NEW_ADDR_TITLE" code="participant.address"/></span>
        <br/>
        <beacon:username userId="${displayNameUserId}"/>
        <%--INSTRUCTIONS--%>
        <br/><br/>
        <span class="content-instruction">
          <cms:contentText key="ADD_INFO" code="participant.address"/>
        </span>
        <br/><br/>
        <%--END INSTRUCTIONS--%>
        ...
        <cms:errors/>
         ...
         <tr class="form-row-spacer">				  
            ...
            <td class="content-field">              
				<html:select property="addressFormBean.countryCode" styleClass="content-field" onchange="maintainUserAddress('changeCountry','userAddressDisplay.do')">
