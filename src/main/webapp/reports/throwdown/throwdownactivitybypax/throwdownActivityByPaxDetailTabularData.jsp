...
String reportUrl = "/reports/displayThrowdownActivityByPaxSummaryReport.do?method=displayDetailReport";
...
"tabularData": [
      {
        "meta": {
          "columns": [
	        ...
	        {
	          "id": "9",
	          "name": "<cms:contentText key="ROUND" code="${report.cmAssetCode}"/>",
	          "description": "<cms:contentText key="ROUND_DESC" code="${report.cmAssetCode}"/>",
	          "type": "string",
	          "alignment": "",
	          "nameId": "",
	          "sortable": true,
	        ...
	        {
	          "id": "10",
	          "name": "<cms:contentText key="ROUND_START_DATE" code="${report.cmAssetCode}"/>",
	          "description": "<cms:contentText key="ROUND_START_DATE_DESC" code="${report.cmAssetCode}"/>",
	          "type": "string",
	          "alignment": "",
	          "nameId": "",
	          "sortable": true,
	        ...
	        {
	          "id": "11",
	          "name": "<cms:contentText key="ROUND_END_DATE" code="${report.cmAssetCode}"/>",
	          "description": "<cms:contentText key="ROUND_END_DATE_DESC" code="${report.cmAssetCode}"/>",
	          "type": "string",
	          "alignment": "",
	          "nameId": "",
	          "sortable": true,
	        ...
	        },
	        {
	          ...
	          "nameId": "",
	          "sortable": true,
	          "sortUrl": "<c:out value="${sortUrl}"/>&sortedOn=17&sortedBy=",
        ...
        "results": [
           	<c:forEach var="reportItem" items="${reportData}" varStatus="reportDataStatus">
				[				
		          ...
		          "<c:out value="${reportItem.roundNumber}" />",
		          "<fmt:formatDate value="${reportItem.roundStartDate}" pattern="${JstlDatePattern}" />",
		          "<fmt:formatDate value="${reportItem.roundEndDate}" pattern="${JstlDatePattern}" />",
