...
<%@page import="com.biperf.core.value.budget.BudgetBalanceReportValue"%>
...
String reportUrl = "reports/displayCashBudgetBalanceReport.do?method=displayBudgetByPromotionSummaryReport";
...
"tabularData": [
      {
        ...
        },
        {
          ...
          "exportCurrentView": {
            ...
            "url": "${systemUrl}/reports/displayCashBudgetBalanceReport.do?method=extractBudgetSecondLevelReport&exportViewType=currentView&extractType=secondary"
          },
