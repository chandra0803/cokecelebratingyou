...
<%@page import="com.biperf.core.value.budget.CashBudgetBalanceReportValue"%>
...
"tabularData": [
  {
    "meta": {
      "columns": [
        ...
        {
          "id": "2",
          "name": "<cms:contentText key="BUDGET_BALANCE_DRILL_DOWN" code="${report.cmAssetCode}"/>",
          "description": "",
          "type": "URL",
          "alignment": "",
          "nameId": "",
        ...
        {
          "id": "4",
          "name": "<cms:contentText key="BUDGET_NAME" code="${report.cmAssetCode}"/>",
          "description": "<cms:contentText key="BUDGET_NAME_DESC" code="${report.cmAssetCode}"/>",
          "type": "string",
          "alignment": "",
          "nameId": "",
          "sortable": true,
      ...
      "exportFullReportUrl": [
        {
          ...
          "url": "${systemUrl}/reports/displayCashBudgetBalanceReport.do?method=extractReport&exportViewType=fullView&extractType=primary"
        },
        {
          "label": "<cms:contentText key="BUDGET_ISSUANCE" code="report.display.page"/>",
          "url": "${systemUrl}/reports/displayCashBudgetBalanceReport.do?method=extractSecondaryReport&exportViewType=fullView"
        }    
      ],
      "exportCurrentView": {
            "label": "<cms:contentText key="EXTRACT_CURRENT" code="report.display.page"/>",
            "url": "${systemUrl}/reports/displayCashBudgetBalanceReport.do?method=extractReport&exportViewType=currentView&extractType=primary"
      },
    ...
    "results": [
		...
		[
		    ...
		    <c:choose>
			<c:when test = "${reportItem.promotionId != 0}">
		    <%
		    	CashBudgetBalanceReportValue reportValue = (CashBudgetBalanceReportValue) pageContext.getAttribute( "reportItem" );
			    Map<String, Object> paramMap = new HashMap<String, Object>();
			    paramMap.put( "drilldownPromoId", reportValue.getPromotionId(  ) );
			    String urlToUse = "/reports/displayCashBudgetBalanceReport.do?method=displayBudgetByPromotionSummaryReport";
