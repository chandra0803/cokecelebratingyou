...
<%@page import="com.biperf.core.value.goalquest.GoalQuestManagerReportValue"%>
...
"tabularData": [
      {
        "meta": {
          "columns": [
            ...
            {
              "id": "2",
              "name": "Goal Quest Manager Drilldown URL",
              "description": "",
              "type": "URL",
              "alignment": "",
              "nameId": "",
          ...
          "exportFullReportUrl": [
            {
              ...
              "url": "${systemUrl}/reports/displayGoalQuestManagerReport.do?method=extractReport&exportViewType=fullView"
            }
          ],
          "exportCurrentView": {
            "label": "<cms:contentText key="EXTRACT_CURRENT" code="report.display.page"/>",
            "url": "${systemUrl}/reports/displayGoalQuestManagerReport.do?method=extractReport&exportViewType=currentView"
          },
        ...
        "results": [
           	<c:forEach var="reportItem" items="${reportData}" varStatus="reportDataStatus">
				[				
		    		...
		    		<%
				    	GoalQuestManagerReportValue reportValue = (GoalQuestManagerReportValue)pageContext.getAttribute( "reportItem" );
					    Map<String, Object> paramMap = new HashMap<String, Object>();
					    paramMap.put( "parentNodeId", reportValue.getOrgId(  ) );
					    paramMap.put( "managerUserId", reportValue.getManagerUserId(  ) );
					    String urlToUse = "/reports/displayGoalQuestManagerReport.do?method=displayDetailReport";
