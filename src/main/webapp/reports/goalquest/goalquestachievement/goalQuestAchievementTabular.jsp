...
<%@page import="com.biperf.core.value.goalquest.GoalQuestAchievementReportValue"%>
...
"tabularData": [
      {
        "meta": {
          "columns": [
            ...
            {
              "id": "2",
              "name": "Goal Quest Achievement Drilldown URL",
              "description": "",
              "type": "URL",
              "alignment": "",
              "nameId": "",
            ...
            <c:if test="${displayLevel1}">
	            ...
	            },
	            {
	              ...
	              "description": "<cms:contentText key="LEVEL_ACHIEVED_DESC" code="${report.cmAssetCode}"/>",
	              "type": "number",
	              "alignment": "",
	              "nameId": "",
	              "sortable": false,
	            ...
	            },
	            {
	              ...
	              "description": "<cms:contentText key="LEVEL_AWARDS_DESC" code="${report.cmAssetCode}"/>",
	              "type": "number",
	              "alignment": "",
	              "nameId": "",
	              "sortable": false,
          ...
          "exportFullReportUrl": [
            {
              ...
              "url": "${systemUrl}/reports/displayGoalQuestAchievementReport.do?method=extractReport&exportViewType=fullView"
            }
          ],
          "exportCurrentView": {
            "label": "<cms:contentText key="EXTRACT_CURRENT" code="report.display.page"/>",
            "url": "${systemUrl}/reports/displayGoalQuestAchievementReport.do?method=extractReport&exportViewType=currentView"
          },
           	...
           	<c:forEach var="reportItem" items="${reportData}" varStatus="reportDataStatus">
				[				
				    ...
				    <c:choose>
				    	...
				    	<%--  <c:when test="${reportItem.isLeaf}"> --%>
				    		<%
				    			GoalQuestAchievementReportValue reportValue = (GoalQuestAchievementReportValue)pageContext.getAttribute( "reportItem" );
							    Map<String, Object> paramMap = new HashMap<String, Object>();
							    paramMap.put( "parentNodeId", reportValue.getOrgId(  ) );
							    paramMap.put( "nodeAndBelow", "false" );
							    String urlToUse = "/reports/displayGoalQuestAchievementReport.do?method=displayDetailReport";
				    	...
				    	<c:otherwise>
				    		<%
							    ...
							    String urlToUse = "/reports/displayGoalQuestAchievementReport.do?method=displaySummaryReport";
							    String drilldownUrl = ClientStateUtils.generateEncodedLink( RequestUtils.getBaseURI(request), urlToUse, paramMap );
							%>
			                "<%=drilldownUrl %>",
				    	</c:otherwise>
				    </c:choose>		    	    		    						    								
				   	"${reportItem.totalPaxCnt}",
					 <c:if test="${displayLevel1}">  
