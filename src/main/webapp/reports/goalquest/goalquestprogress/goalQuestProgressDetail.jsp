...
String reportUrl = "/reports/displayGoalQuestProgressReport.do?method=displayDetailReport";
        ...
        "meta": {
          "columns": [
            ...
            },
            {
              ...
              "summary": "<fmt:formatNumber value="${totalsRowData.goalAchieve}"/>"
            },
            {
              "id": "7",
        ...
        "results": [
           	<c:forEach var="reportItem" items="${reportData}" varStatus="reportDataStatus">
				[				
					...
					"<fmt:formatNumber value="${reportItem.goalAchieve}"/>",
