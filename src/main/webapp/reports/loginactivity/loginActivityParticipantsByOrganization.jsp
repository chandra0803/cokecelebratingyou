...
String reportUrl = "/reports/displayLoginActivityByOrgReport.do?method=displayParticipantList";
          ...
          "exportFullReportUrl": [
            {
              ...
              "url": "${systemUrl}/reports/displayLoginActivityByOrgReport.do?method=extractReport"
            }
          ],
          "exportCurrentView": {
