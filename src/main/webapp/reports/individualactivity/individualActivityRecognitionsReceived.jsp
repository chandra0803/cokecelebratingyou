...
sortMap.put( "displayType", "recognitionsReceived" );
...
"tabularData": [
  {
    "meta": {
      "columns": [
        ...
        {
          "id": "2",
          "name": "<cms:contentText key="DATE_RECEIVED" code="${report.cmAssetCode}"/>",
          "description": "",
          "type": "string",
          "alignment": "",
          "nameId": "",
        ...
        },
        {
          ...
          "description": "<cms:contentText key="SENDER_DESC" code="${report.cmAssetCode}"/>",
          "type": "string",
          "alignment": "",
          "nameId": "",
          "sortable": true,
      ...
      "exportFullReportUrl": [
        {
          ...
          "url": "${systemUrl}/reports/displayIndividualActivityReport.do?method=extractReport&exportLevel=recognitionsReceived"
        }
      ],
      "exportCurrentView": {
    ...
    "results": [
     <c:forEach var="reportItem" items="${reportData}" varStatus="reportDataStatus">
     	<c:if test="${reportDataStatus.index !=0 }">,</c:if>
          ...
          <c:choose>
          <c:when test="${reportItem.claimId ne 0 }">
          ...
          "<c:out value="${reportItem.giverName}" />",
          "<fmt:formatNumber value="${reportItem.pointsCount}" />",
          "<fmt:formatNumber value="${reportItem.plateauEarnedCount}" />",
