...
sortMap.put( "displayType", "nominationsGiven" );
      ...
      "exportFullReportUrl": [
        {
          ...
          "url": "${systemUrl}/reports/displayIndividualActivityReport.do?method=extractReport&exportLevel=nominationsGiven"
        }
      ],
      "exportCurrentView": {
    ...
    "results": [
     <c:forEach var="reportItem" items="${reportData}" varStatus="reportDataStatus">
     	<c:if test="${reportDataStatus.index !=0 }">,</c:if>
		  ...
		  %>
		  "${systemUrl}/<%=detailUrl%>",
          "<c:out value="${reportItem.nomineeName}" />",
