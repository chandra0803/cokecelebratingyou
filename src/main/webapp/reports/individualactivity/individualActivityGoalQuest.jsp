...
sortMap.put( "displayType", "goalQuest" );
...
"tabularData": [
  {
    "meta": {
      "columns": [
        ...
        {
          "id": "7",
          "name": "<cms:contentText key="PCT_OF_GOAL" code="${report.cmAssetCode}"/>",
          "description": "",
          "type": "number",
          "alignment": "",
          "nameId": "",
      ...
      "exportFullReportUrl": [
        {
          ...
          "url": "${systemUrl}/reports/displayIndividualActivityReport.do?method=extractReport&exportLevel=goalquest"
        }
      ],
      "exportCurrentView": {
    ...
    "results": [
     <c:forEach var="reportItem" items="${reportData}" varStatus="reportDataStatus">
     	<c:if test="${reportDataStatus.index !=0 }">,</c:if>
          ...
          "<c:out value="${reportItem.goalLevelName}" />",
          ...
          "<fmt:formatNumber value="${reportItem.percentageOfGoal}" />",
