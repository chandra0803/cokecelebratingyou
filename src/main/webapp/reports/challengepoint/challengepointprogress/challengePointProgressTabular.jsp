...
<%@page import="com.biperf.core.value.challengepoint.ChallengePointProgressReportValue"%>
...
"tabularData": [
      {
        "meta": {
          "columns": [
            ...
            {
              "id": "2",
              "name": "<cms:contentText key="CHALLENGE_POINT_PROGRESS_URL" code="${report.cmAssetCode}"/>",
              "description": "",
              "type": "URL",
              "alignment": "",
              "nameId": "",
            ...
            --%>
            {
              ...
              "description": "<cms:contentText key="LEVEL_DESC" code="${report.cmAssetCode}"/>",
              "type": "number",
              "alignment": "",
              "nameId": "",
              "sortable": true,
				...
				[
				    ...
				    <c:choose>
				    	<c:when test="${reportItem.isLeaf}">
				    		<%
				    		ChallengePointProgressReportValue reportValue = (ChallengePointProgressReportValue)pageContext.getAttribute( "reportItem" );
							    Map<String, Object> paramMap = new HashMap<String, Object>();
							    paramMap.put( "parentNodeId", reportValue.getOrgId(  ) );
							    paramMap.put( "nodeAndBelow", "false" );
							    String urlToUse = "/reports/displayChallengePointProgressReport.do?method=displayDetailReport";
				    	...
				    	<c:otherwise>
				    		...
				    		ChallengePointProgressReportValue reportValue = (ChallengePointProgressReportValue)pageContext.getAttribute( "reportItem" );
							    ...
							    String urlToUse = "/reports/displayChallengePointProgressReport.do?method=displaySummaryReport";
							    String drilldownUrl = ClientStateUtils.generateEncodedLink( RequestUtils.getBaseURI(request), urlToUse, paramMap );
							%>
			                "<%=drilldownUrl %>",
				    	</c:otherwise>
