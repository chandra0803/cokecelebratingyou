...
<%@page import="com.biperf.core.value.challengepoint.ChallengePointSelectionReportValue"%>
...
"tabularData": [
      {
        "meta": {
          "columns": [
            ...
            {
              "id": "2",
              "name": "<cms:contentText key="CHALLENGE_POINT_SELECTION_URL" code="${report.cmAssetCode}"/>",
              "description": "",
              "type": "URL",
              "alignment": "",
              "nameId": "",
          ...
          "exportFullReportUrl": [
            {
              ...
              "url": "${systemUrl}/reports/displayChallengePointSelectionReport.do?method=extractReport&exportViewType=fullView"
            }
          ],
          "exportCurrentView": {
            "label": "<cms:contentText key="EXTRACT_CURRENT" code="report.display.page"/>",
            "url": "${systemUrl}/reports/displayChallengePointSelectionReport.do?method=extractReport&exportViewType=currentView"
          },
				...
				[
				    ...
				    <c:choose>
				        <c:when test="${ fn:contains(  reportItem.orgId ,reportParametersForm.parentNodeId ) }">
				    		<%
				    			ChallengePointSelectionReportValue reportValue = (ChallengePointSelectionReportValue)pageContext.getAttribute( "reportItem" );
							    Map<String, Object> paramMap = new HashMap<String, Object>();
							    paramMap.put( "parentNodeId", reportValue.getOrgId(  ) );
							    paramMap.put( "nodeAndBelow", "false" );
							    String urlToUse = "/reports/displayChallengePointSelectionReport.do?method=displayDetailReport";
