...
<%@page import="com.biperf.core.value.challengepoint.ChallengePointManagerReportValue"%>
...
"tabularData": [
      {
        "meta": {
          "columns": [
            ...
            {
              "id": "2",
              "name": "<cms:contentText key="CHALLENGE_POINT_MANAGER_DRILLDOWN" code="${report.cmAssetCode}"/>",
              "description": "",
              "type": "URL",
              "alignment": "",
              "nameId": "",
        ...
        "results": [
           	<c:forEach var="reportItem" items="${reportData}" varStatus="reportDataStatus">
				[
				    ...
				    <%
				    	ChallengePointManagerReportValue reportValue = (ChallengePointManagerReportValue)pageContext.getAttribute( "reportItem" );
					    Map<String, Object> paramMap = new HashMap<String, Object>();
					    paramMap.put( "parentNodeId", reportValue.getOrgId(  ) );
					    paramMap.put( "managerUserId", reportValue.getManagerUserId(  ) );
					    String urlToUse = "/reports/displayChallengePointManagerReport.do?method=displayDetailReport";
