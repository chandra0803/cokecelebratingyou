...
String reportUrl = "/reports/displayRecognitionGivenByOrgReport.do?method=displayDetailReport";
...
"tabularData": [
      {
        "meta": {
          "columns": [
            {
              "id": "1",
              "name": "<cms:contentText key="GIVER_NAME" code="${report.cmAssetCode}"/>",
              "description": "<cms:contentText key="GIVER_NAME_DESC" code="${report.cmAssetCode}"/>",
              "type": "string",
              "alignment": "",
              "nameId": "",
              "sortable": true,
            ...
            },
            {
              ...
              "summary": "<fmt:formatNumber value="${totalsRowData.totalRecognitions}"/>"
            },
            {
              "id": "3",
              ...
              "summary": "<fmt:formatNumber value="${totalsRowData.totalRecognitionPoints}"/>"
            },
            {
              "id": "4",
              ...
              "summary": "<fmt:formatNumber value="${totalsRowData.totalPlateauEarnedCnt}"/>"
            }
            <%--
            {
              "id": "5",
              ...
              "summary": "<fmt:formatNumber value="${totalsRowData.totalSweepstakesWonCnt}"/>"
            }
            --%>
          ],
          <c:choose>
