        ...
        "meta": {
          "columns": [
            ...
            },
            {
              ...
              "sortUrl": "",
              "summary": ""
            }<c:if test="${! empty promotionRecognitionBehaviorTypeList }">,</c:if>
            <c:forEach var="promotionBehavior" items="${promotionRecognitionBehaviorTypeList}" varStatus="behaviorStatus">
				{
	            ...
	            <c:if test="${behaviorStatus.index < fn:length(promotionRecognitionBehaviorTypeList) - 1}">,</c:if>
			</c:forEach>                               
          ],
          <c:choose>
          ...
          "exportFullReportUrl": [
            {
              ...
              "url": "${systemUrl}/reports/displayRecognitionBehaviorsReport.do?method=extractReport&exportViewType=fullView"
            }
          ],
          "exportCurrentView": {
            "label": "<cms:contentText key="EXTRACT_CURRENT" code="report.display.page"/>",
            "url": "${systemUrl}/reports/displayRecognitionBehaviorsReport.do?method=extractReport&exportViewType=currentView"
          },
      	  "inlineTextDescription": ""
        },
        "results": [
         <c:if test="${not empty promotionRecognitionBehaviorTypeList}" >
        			...
        			<c:choose>
		    			...
		    			<c:otherwise>
		    				<%
							    ...
							    String urlToUse = "/reports/displayRecognitionBehaviorsReport.do?method=displaySummaryReport";
