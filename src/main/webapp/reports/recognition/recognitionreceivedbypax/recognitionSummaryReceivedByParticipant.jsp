		        ...
		        <c:forEach var="reportItem" items="${reportData}" varStatus="reportDataStatus">
		          ...
		          [
			        ...
			        <%
            		  ...
            		  paramMap.put("receiverNodeId", reportValue.getReceiverNodeId() );
			    	  String urlToUse = "/reports/displayRecognitionReceivedByPaxReport.do?method=displayActivityDetailReport";
