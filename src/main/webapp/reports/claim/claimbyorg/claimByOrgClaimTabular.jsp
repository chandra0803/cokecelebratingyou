...
String reportUrl = "/reports/displayClaimByOrgReport.do?method=displayClaimListSummaryReport";
...
"tabularData": [
      {
        "meta": {
          ...
          "exportCurrentView": {
            ...
            "url": "${systemUrl}/reports/displayClaimByOrgReport.do?method=extractReport&exportViewType=currentView&exportLevel=paxLevel"
          },
