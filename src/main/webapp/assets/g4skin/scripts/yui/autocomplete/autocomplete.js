 ...
 * @default 0.2
 */
YAHOO.widget.AutoComplete.prototype.queryDelay = 0.8;
...
//}
    ...
    //CHRIS NOTE: added the '&& this.connMgr' to if clause
    if(this._oConn && this.connMgr) 
    {
        this.connMgr.abort(this._oConn);
    }
    
    // CHRIS NOTE: always using the YAHOO.util.Connect to get the connection.  not sure of the consequences though
