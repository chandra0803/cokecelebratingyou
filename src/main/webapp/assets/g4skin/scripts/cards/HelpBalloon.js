...
dropmenuobj.style.left=(dropmenuobj.x - 200)-clearbrowseredge(obj, "rightedge")+"px"
dropmenuobj.style.top=(dropmenuobj.y-140)-clearbrowseredge(obj, "bottomedge")+obj.offsetHeight+"px"
if (enablearrowhead)
displaytiparrow()
}
