...
;(function($) {
	...
	$.fn.fancybox = function(settings) {
		...
		function _set_navigation() {
			if ( opts.itemCurrent != 0 && !opts.noGallery ) { // MOD: noGallery
			...
			if ( opts.itemCurrent != ( opts.itemArray.length -1 ) && !opts.noGallery ) { // MOD: noGallery
