...
<div class="emptyMsg alert" style="display:none">Y<cms:contentText key="NOT_ADDED_ANYONE" code="ssi_contest.pax.manager"/></div>
        ...
        <thead>
            <tr>
                <th class="sortHeader unsorted date" data-sort="dateCreated">
                    <a href="#">
                        <cms:contentText key="DATE_CREATED" code="ssi_contest.atn.summary"/>
                ...
                <th class="sortHeader unsorted number" data-sort="participantsCount">
                    <a href="#">
                        <cms:contentText key="NO_OF_PARTICIAPNTS" code="ssi_contest.atn.summary"/>
                        <i class="icon-arrow-1-up"></i>
                        <i class="icon-arrow-1-down"></i>
                    </a>
                </th>
                <th class="sortHeader unsorted number" data-sort="amount">
                    <a href="#">
                        <cms:contentText key="ACTIVITY_AMOUNT" code="ssi_contest.atn.summary"/>
                        <i class="icon-arrow-1-up"></i>
                        <i class="icon-arrow-1-down"></i>
                    </a>
                </th>
                ...
                <th class="sortHeader unsorted number" data-sort="payoutAmount">
                    <a href="#">
                        <cms:contentText key="PAYOUT" code="ssi_contest.atn.summary"/>
                        <i class="icon-arrow-1-up"></i>
                        <i class="icon-arrow-1-down"></i>
                    </a>
                </th>
                ...
                <th class="sortHeader unsorted" data-sort="payoutDescription">
                    <a href="#">
                        <cms:contentText key="PAYOUT_DESCRIPTION" code="ssi_contest.atn.summary"/>
                        <i class="icon-arrow-1-up"></i>
                        <i class="icon-arrow-1-down"></i>
                    </a>
                </th>
                <th class="sortHeader unsorted number" data-sort="payoutAmount">
                    <a href="#">
                        <cms:contentText key="VALUE" code="ssi_contest.atn.summary"/>
                        <i class="icon-arrow-1-up"></i>
                        <i class="icon-arrow-1-down"></i>
                    </a>
                </th>
        ...
        <tfoot>
            <tr>
                <td class="totalDisp number">
                    <cms:contentText key="TOTAL" code="ssi_contest.atn.summary"/>
                </td>
                <td class="totalDisp number">
