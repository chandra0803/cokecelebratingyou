                ...
                <thead>
                    <tr>
                        ...
                        <th class="sortHeader unsorted number" data-sort="goal">
                            <a href="#">
                                <cms:contentText key="OBJECTIVE" code="ssi_contest.payout_objectives" />
                                <i class="icon-arrow-1-up"></i>
                                <i class="icon-arrow-1-down"></i>
                            </a>
                        </th>
                        ...
                        {{#eq payoutType "points"}}
                            <th class="sortHeader unsorted columnEmphasis number" data-sort="objectivePayout">
                                <a href="#">
                                    <cms:contentText key="OBJECTIVE_PAYOUT" code="ssi_contest.payout_objectives" />
                                    <i class="icon-arrow-1-up"></i>
                                    <i class="icon-arrow-1-down"></i>
                                </a>
                            </th>
    ...
    <tr class="record-item" data-participant-id="{{id}}">
        ...
        {{#eq extraJSON.payoutType "points"}}
            <td class="number columnEmphasis">
                {{#if objectivePayout}}
                    {{#if optOutAwards}}<cms:contentText key="USER_OPTED_OUT_OF_AWARDS" code="recognition.merchandise"/>{{else}}{{objectivePayout}}{{/if}}
                {{else}}
                    --
                {{/if}}
            </td>
