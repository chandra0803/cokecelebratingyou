...
<display:setProperty name="basic.empty.showtable" value="true"></display:setProperty>
  ...
  <display:column property="activityDescription" titleKey="admin.fileload.ssicontest.ACTIVITY_DESCRIPTION" headerClass="crud-table-header-row" class="crud-content nowrap top-align" sortable="false" sortName="activityDescription"/>
  <display:column property="activityAmount" titleKey="admin.fileload.ssicontest.ACTIVITY_AMOUNT" headerClass="crud-table-header-row" class="crud-content nowrap top-align" sortable="false" sortName="activityAmount"/>
  <display:column property="payoutAmount" titleKey="admin.fileload.ssicontest.PAYOUT_AMOUNT" headerClass="crud-table-header-row" class="crud-content nowrap top-align" sortable="false" sortName="payoutAmount"/>
  <display:column property="payoutDescription" titleKey="admin.fileload.ssicontest.PAYOUT_DESCRIPTION" headerClass="crud-table-header-row" class="crud-content nowrap top-align" sortable="false" sortName="payoutDescription"/>
  <display:column property="awardIssueValue" titleKey="admin.fileload.ssicontest.AWARD_ISSUE_VALUE" headerClass="crud-table-header-row" class="crud-content nowrap top-align" sortable="false" sortName="awardIssueValue"/>
