...
{
	var radioList = document.recognitionAwardsLevelForm.cardId ;
                  ...
                  <table width="100%">
                    <tr>
                      ...
                      <td id="cardOuterTd_-1" class="outerCard" align="center" width="20%" 
                      		...
                      		onmouseout="if( !document.recognitionAwardsLevelForm.cardId[0].checked ){ YAHOO.util.Dom.replaceClass(this, 'outerCardOn', 'outerCard'); }" 
							...
							<table align="center" cellpadding="10" valign="center">
                          	...
                          	<br>
                          	<html:radio onclick="selectCardFromRadio( document.getElementById('cardTd_-1'), '-1' );" name="recognitionAwardsLevelForm" value="-1" property="cardId" styleId="radio_-1"/>
                          	<%-- highlight this card if it was previously selected --%>
                          	<c:if test="${ recognitionAwardsLevelForm.cardId == '-1' || null==recognitionAwardsLevelForm.cardId }">
                          		<script language="JavaScript">
                         			selectCard(null, -1);
                          		</script>
                          	</c:if>
                      ...
                      <c:forEach items="${electronicCards}" var="promotionECard" varStatus='status'>
                        ...
                        <td id="cardOuterTd_<c:out value="${ecardIndex}"/>" class="outerCard" align="center" width="20%" onclick="selectCard( this, '<c:out value="${ecardIndex}"/>' );" >
							...
							<table align="center" cellpadding="10" valign="center">
                          	...
                          	<html:radio onclick="selectCardFromRadio( document.getElementById('cardTd_${ecardIndex}'), '${ecardIndex}' );" name="recognitionAwardsLevelForm" value="${ formattedId  }" property="cardId" styleId="radio_${ecardIndex}"  />
                          	<%-- highlight this card if it was previously selected --%>
                          	<c:if test="${ recognitionAwardsLevelForm.cardId == formattedId }">
