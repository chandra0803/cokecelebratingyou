...
<display:setProperty name="basic.empty.showtable" value="true"></display:setProperty>
  ...
  <display:column property="baseLine" titleKey="admin.fileload.ssicontest.BASELINE" headerClass="crud-table-header-row" class="crud-content nowrap top-align" sortable="false" sortName="baseLine"/>
