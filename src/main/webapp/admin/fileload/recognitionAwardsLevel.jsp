...
<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
 ...
 function previewRecOptionsMessage(obj)
  ...
  <html:form styleId="contentForm" action="displayRecognitionAward">
  <html:hidden property="method" styleId="method"/>
  <html:hidden property="submitterId" value="${recognitionAwardsLevelForm.submitterId}" styleId="submitterId"/>
  <html:hidden property="submitterNodeId" value="${recognitionAwardsLevelForm.submitterNodeId}" styleId="submitterNodeId"/>
  <html:hidden property="importFileId" value="${recognitionAwardsLevelForm.importFileId}" styleId="importFileId"/>
  <html:hidden property="promotionId" value="${recognitionAwardsLevelForm.promotionId}" styleId="promotionId"/>
  <html:hidden property="messageId" value="${recognitionAwardsLevelForm.messageId}" styleId="messageId"/>
  ...
  <table border="0" cellpadding="20" cellspacing="0" width="100%">
    <tr>
      ...
      <table border="0" cellpadding="3" cellspacing="1" width="100%">
		...
		<tr>
			...
			<c:choose>
				<c:when test="${empty recognitionAwardsLevelForm.submitterName}">
					<cms:contentText code="proxy.detail" key="NONE_DEFINED" />
				</c:when>
				<c:otherwise>
					<c:out value="${recognitionAwardsLevelForm.submitterName}"/>
				</c:otherwise>
			</c:choose></td>
		</tr>
			        ...
			        <table border="0" cellpadding="0" cellspacing="0">	    
								<tr class="form-row-spacer">
								  ...
								  <td colspan=2 class="content-field">
								  	<table>
											<tr>
												<td class="content-field"><html:radio property="copyManager" value="false"  styleId="copyManager" /></td>
												<td class="content-field"><cms:contentText code="system.common.labels" key="NO"/></td>
											</tr>
											<tr>
												<td class="content-field"><html:radio property="copyManager" value="true" styleId="copyManager" /></td>
	...
	<table width="100%">
		<tr class="form-buttonrow">
			<td class="headline" align="center"><html:hidden
				property="method" value="prepareCreate" /> <html:submit
