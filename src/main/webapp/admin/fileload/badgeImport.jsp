...
<display:setProperty name="basic.empty.showtable" value="true"></display:setProperty>
  ...
  <display:column property="userName" titleKey="admin.fileload.badge.USER_NAME" headerClass="crud-table-header-row" class="crud-content nowrap top-align" sortable="false" sortName="userName"/>
  <display:column property="badgeName" titleKey="admin.fileload.badge.BADGE_NAME" headerClass="crud-table-header-row" class="crud-content nowrap top-align" sortable="false" sortName="badgeName"/> 
</display:table>
