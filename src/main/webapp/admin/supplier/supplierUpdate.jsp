...
<html:form styleId="contentForm" action="supplierEdit" focus="supplierName">
  <html:hidden property="method" />
  <html:hidden property="version"/>
  <html:hidden property="dateCreated"/>
  <html:hidden property="createdBy"/>
	<beacon:client-state>
	  <beacon:client-state-entry name="supplierId" value="${supplierForm.supplierId}"/>
	  <beacon:client-state-entry name="cmAssetCode" value="${supplierForm.cmAssetCode}"/>
	</beacon:client-state>
  
    <table border="0" cellpadding="10" cellspacing="0" width="100%">
    <tr>
      <td>
        <span class="headline"><cms:contentText key="EDIT_HEADER" code="admin.supplier.details"/></span>
	 	...
	 	<table>
          ...
          <tr class="form-row-spacer">			
            ...
            <td class="content-field content-field-label-top">
              <html:radio property="supplierType" value="internal" onclick="allowSSO()"/>&nbsp;&nbsp;<cms:contentText key="INTERNAL_TYPE" code="admin.supplier.details"/>
               <br/>
              <html:radio property="supplierType" value="external" onclick="allowSSO()"/>&nbsp;&nbsp;<cms:contentText key="EXTERNAL_TYPE" code="admin.supplier.details"/>
            </td>
          </tr> 
