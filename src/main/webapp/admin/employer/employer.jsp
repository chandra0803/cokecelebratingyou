...
<html:form styleId="contentForm" action="employerMaintainUpdate">
  <html:hidden property="method" value="update"/>
  <html:hidden property="version"/>
  <html:hidden property="dateCreated"/>
  <html:hidden property="createdBy"/>
	<beacon:client-state>
	  <beacon:client-state-entry name="id" value="${employerForm.id}"/>
	</beacon:client-state>
  
  <table border="0" cellpadding="10" cellspacing="0" width="100%">
    <tr>
      <td>
        <span class="headline"><cms:contentText key="UPDATE_HEADER" code="employer.list"/></span>
        
        <%--INSTRUCTIONS--%>
        <br/><br/>
        <span class="content-instruction">
          <cms:contentText key="UPDATE_INFO" code="employer.list"/>
        </span>
        <br/><br/>
        <%--END INSTRUCTIONS--%>
        ...
        <cms:errors/>
	     ...
	     <tr class="form-row-spacer">				  
            ...
            <td class="content-field">
              <html:select property="addressFormBean.countryCode" styleClass="content-field" onchange="maintainEmployer('changeCountryUpdate','employerDisplay.do')">
