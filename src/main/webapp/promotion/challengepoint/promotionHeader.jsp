...
<c:choose>
  ...
  <c:when test="${pageNumber == '3'}">
      <% status3 = "step-number-on";
         codeName = "promotion.payout.challengepoint"; %>   
  </c:when>    
  ...
  <c:when test="${pageNumber == '23'}">
	   <% status6 = "step-number-on";
       codeName = "promotion.webrules"; %>
  </c:when>
  
  <c:when test="${pageNumber == '24'}">
	   <% status8 = "step-number-on";
       codeName = "promotion.translation"; %>
  </c:when>
              ...
              <table class="step-table">
                ...
                <c:choose>
                  ...
                  <c:otherwise>
                    ...
                    <td class="<%=status2%>" nowrap>2</td>
                    <td class="<%=status3%>" nowrap>3</td>
                    <td class="<%=status9%>" nowrap>4</td>
                    <td class="<%=status4%>" nowrap>5</td>
                    <td class="<%=status5%>" nowrap>6</td>
                    <td class="<%=status6%>" nowrap>7</td>
                    <td class="<%=status7%>" nowrap>8</td>
                    <td class="<%=status8%>" nowrap>9</td>
                  </c:otherwise>
                </c:choose>
				</tr>
                <tr>
