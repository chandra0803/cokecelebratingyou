...
<c:if test="${productClaimSubmissionForm.why =='why_before'}">
	<div class="control-group">
		<label class="control-label"> <cms:contentText key="WHY" code="promotion.wizard" />
		</label>
		<div class="controls">
			<textarea id="WhyTextBox"
				name="WhyTextBox" cols="75" rows="10"></textarea>
		</div>
	</div>
</c:if>
...
<c:forEach var="status" items="${productClaimSubmissionForm.claimElementForms}">
  ...
  <fieldset class="formSection ${sectionId} customSection" id="${sectionId}" data-custom-section-id="${sectionId}">
...
<c:if test="${productClaimSubmissionForm.why =='why_after'}">
	<div class="control-group">
		<label class="control-label"> <cms:contentText key="WHY" code="promotion.wizard" />
		</label>
		<div class="controls">
