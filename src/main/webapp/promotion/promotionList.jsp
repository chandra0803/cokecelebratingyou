                ...
                <c:set var="index" value="1"/>
				  ...
				  <display:setProperty name="basic.empty.showtable" value="true"></display:setProperty>
                    ...
                    <display:column titleKey="promotion.list.PROMO_NAME" headerClass="crud-table-header-row" class="crud-content left-align top-align nowrap" sortable="true" sortProperty="name">
                      <c:choose>
                        ...
                        <c:when test='${underConstruction.promotionType.code == "product_claim" and underConstruction.parentPromotion.id > 0 and underConstruction.parentPromotion.id == savedPromotionId}'>
                          &nbsp;&nbsp;&nbsp;
                          <a href="<c:out value="${viewUrl}"/>" class="crud-content-link"><c:out value="${underConstruction.promotionName}"/></a>
                        </c:when>
                        <c:otherwise>
                          <a href="<c:out value="${viewUrl}"/>" class="crud-content-link"><c:out value="${underConstruction.promotionName}"/></a>
                        </c:otherwise>
                    ...
                    <display:column titleKey="promotion.list.PROMO_FORM" headerClass="crud-table-header-row" class="crud-content left-align top-align" sortable="true" sortProperty="claimForm.name">
                      <c:choose>
                        <c:when test="${underConstruction.promotionType.code == 'survey' or underConstruction.promotionType.code == 'goalquest' or underConstruction.promotionType.code =='challengepoint' or underConstruction.promotionType.code =='diy_quiz'}">
                          <cms:contentText code="promotion.list" key="FAMILY_NA"/>
                        </c:when>
                        <c:otherwise>
                    ...
                    <display:column titleKey="promotion.list.PROMO_LAST_UPDATED" headerClass="crud-table-header-row" class="crud-content left-align top-align nowrap" sortable="true">
              ...
              <tr class="form-row-spacer">
                <td colspan="2">
                  ...
                  <display:setProperty name="basic.msg.empty_list_row">
                    ...
                    <display:column titleKey="promotion.list.PROMO_NAME" headerClass="crud-table-header-row" class="crud-content left-align top-align nowrap" sortable="true" sortProperty="name">
                      <c:choose>
                        ...
                        <c:when test='${complete.promotionType.code == "product_claim" and complete.parentPromotion.id > 0 and complete.parentPromotion.id == savedPromotionId}'>
                          &nbsp;&nbsp;&nbsp;
                          <a href="<c:out value="${viewCompUrl}"/>" class="crud-content-link"><c:out value="${complete.promotionName}"/></a>
                        </c:when>
                        <c:otherwise>
                          <a href="<c:out value="${viewCompUrl}"/>" class="crud-content-link"><c:out value="${complete.promotionName}"/></a>
                        </c:otherwise>
                    ...
                    <display:column titleKey="promotion.list.PROMO_FORM" headerClass="crud-table-header-row" class="crud-content left-align top-align" sortable="true" sortProperty="claimForm.name">
                      <c:choose>
                        <c:when test="${complete.promotionType.code == 'survey' or complete.promotionType.code == 'goalquest' or complete.promotionType.code =='challengepoint' or complete.promotionType.code =='diy_quiz'}">
                          <cms:contentText code="promotion.list" key="FAMILY_NA"/>
                        </c:when>
                        <c:otherwise>
         ...
         <display:column titleKey="promotion.list.PROMO_NAME" headerClass="crud-table-header-row" class="crud-content left-align top-align nowrap" sortable="true" sortProperty="name">
           ...
           <%-- If Recognition Promotion then children are not applicable --%>
             ...
             <c:otherwise>
              ...
              <display:column titleKey="promotion.list.PROMO_FORM" headerClass="crud-table-header-row" class="crud-content left-align top-align" sortable="true" sortProperty="claimForm.name">
                <c:choose>
                <c:when test="${live.promotionType.code == 'survey' or live.promotionType.code == 'goalquest' or live.promotionType.code =='challengepoint' or live.promotionType.code =='diy_quiz'}">
                  <cms:contentText code="promotion.list" key="FAMILY_NA"/>
                </c:when>
                <c:otherwise>
              ...
              <table width="100%">
                <tr>
                  <td align="left">
                   ...
                   <td>
                  <html:button property="cancelBtn" styleClass="content-buttonstyle" onclick="callUrl('../homePage.do')" >
