...
<SCRIPT type="text/javascript">
    ...
    function enableBillCode3()
    {
      ...
      {
		    document.getElementById('customValue3').value = "" ;
    ...
    function enableBillCode4()
    {
      ...
      {
            document.getElementById('customValue4').value = "" ;
    ...
    function enableBillCode5()
    {
      ...
      {
            document.getElementById('customValue5').value = "" ;
    ...
    function enableBillCode6()
    {
      ...
      {
            document.getElementById('customValue6').value = "" ;
    ...
    function enableBillCode7()
    {
      ...
      {
            document.getElementById('customValue7').value = "" ;
    ...
    function enableBillCode8()
    {
      ...
      {
            document.getElementById('customValue8').value = "" ;
    ...
    function enableBillCode9()
    {
      ...
      {
            document.getElementById('customValue9').value = "" ;
    ...
    function enableBillCode10()
    {
      ...
      {
            document.getElementById('customValue10').value = "" ;
