	...
	<tr>
	  <td width="50%" valign="top">
		      ...
		      <tr class="form-blank-row">
	           <td></td>
		           ...
		           <tr class="form-row-spacer">
			  	  <td valign="top">*</td>
			      <td class="content-field-label" valign="top"><cms:contentText code="promotion.webrules" key="GOAL_SELECTION_SURVEY"/>&nbsp;</td>
        ...
        <nested:iterate id="notificationValue" name="promotionNotificationForm" property="notificationList">
          ...
          or notificationValue.notificationType == 'gq_non_redemption_reminder'}">
  	        <tr class="form-row-spacer">
  	          <td colspan="2">&nbsp;</td>
  	          <td colspan="3" class="content-field">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  	          &nbsp;&nbsp;&nbsp;&nbsp;
  	                <c:if test="${notificationValue.notificationType == 'gq_non_redemption_reminder'}">
  		       ...
  		       <c:if test="${notificationValue.notificationType == 'gq_non_redemption_reminder' && promotionNotificationForm.endSubmissionDate != null }">
  		      <tr class="form-row-spacer">
  	          <td colspan="2">&nbsp;</td>
  	          <td colspan="3" class="content-field">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  	          &nbsp;&nbsp;&nbsp;&nbsp;
