...
<table border="0" cellpadding="10" cellspacing="0" width="100%">
	<tr>
	  <td>
		<span class="headline"><cms:contentText key="TITLE" code="promotion.goalquest.registrationcodes"/></span>
		<br/><br/>
		...
		<br/><br/>
     	<span class="content-instruction">
			<cms:contentText key="INSTRUCTION" code="promotion.goalquest.registrationcodes"/>
     	</span>
     	<br/><br/>
     	<%--END INSTRUCTIONS--%>
     	<cms:errors/>
    	  ...
    	  <tr>
	    	<td align="center">
			  ...
			  <display:setProperty name="basic.msg.empty_list_row">
				...
				<display:column titleKey="promotion.goalquest.registrationcodes.NODE_NAME" headerClass="crud-table-header-row" class="crud-content center-align">
					<c:out value="${promotionRegistrationCode.nodeName}"/>
		        </display:column>	
		        <display:column titleKey="promotion.goalquest.registrationcodes.NODE_TYPE" headerClass="crud-table-header-row" class="crud-content center-align">
					<cms:contentText key="${promotionRegistrationCode.cmKey}" code="${promotionRegistrationCode.cmAssetCode}"/>
		        </display:column>
				<display:column titleKey="promotion.goalquest.registrationcodes.REGISTRATION_CODE" headerClass="crud-table-header-row" class="crud-content center-align">
