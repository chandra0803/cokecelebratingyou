...
<%@ include file="/include/taglib.jspf"%>
    ...
    <table class="crud-table" width="100%">
      <tr>
        ...
        <th valign="top" class="crud-table-header-row">
            <cms:contentText code="promotion.manageroverride" key="PERCENT"/>
            <cms:contentText code="promotion.manageroverride" key="ACHIEVEMENT_AMOUNT"/>
        </th>
      </tr>                                                
      ...
      <nested:iterate id="managerOverride" name="promotionManagerOverrideForm" property="managerOverrideValueAsList" indexId="managerOverrideIndex">
        ...
        <c:choose>
          <c:when test="${displayFlag2 == 'false'}">  
            <td align="center">
              <nested:text property="award" size="10" maxlength="10" styleClass="content-field" />        
            </td>
          </c:when>
          <c:otherwise>
            <td align="center">
