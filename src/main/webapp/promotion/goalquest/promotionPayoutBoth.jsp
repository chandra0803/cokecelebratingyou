...
<%@ include file="/include/taglib.jspf"%>
    ...
    <table class="crud-table" width="100%">
      <tr>
        ...
        <th valign="top" class="crud-table-header-row">
            *<cms:contentText code="promotion.payout.goalquest" key="BONUS"/><br>
            <cms:contentText code="promotion.payout.goalquest" key="AWARD"/>
        </th>
        <th valign="top" class="crud-table-header-row">
      ...
      <nested:iterate id="goalLevel" name="payoutForm" property="goalLevelValueList" indexId="goalLevelIndex">
        ...
        <c:choose>
          <c:when test="${displayFlag2 == 'false'}">           
            ...
            <td align="center">
              <nested:text property="achievementAmount" size="10" maxlength="20" styleClass="content-field" />        
            </td>
            <td align="center">
            ...
            <td align="center">
              <nested:text property="bonusAward" size="10" maxlength="20" styleClass="content-field" />        
            </td>
            <td align="center">
          ...
          <c:otherwise>
            ...
            <td align="center">
              <nested:write property="bonusAward" />        
            </td>
            <td align="center">
