...
<SCRIPT TYPE="text/javascript">  
          ...
          var giversAmountQuizObj = document.getElementById("giversAmountQuiz");
          var giversAmountTypeQuizObj = document.getElementById("giversAmountTypeQuiz");
          var giversAwardTypeAmountQuizObj = document.getElementById("giversAwardTypeAmountQuiz");
   ...
   //End inline javascript
    ...
    var disabled = activeFalseObj.checked == true;
      ...
      giversAmountQuizObj.disabled=disabled;
      giversAmountTypeQuizObj.disabled=disabled;
      giversAwardTypeAmountQuizObj.disabled=disabled;
      if(activeFalseObj.checked == true)
    	{
	  	  	$("input[id='giversAmountQuiz']").val("");
	        $("select[id='giversAmountTypeQuiz'] option[value='specific']").attr('selected', 'selected');
	        $("input[id='giversAwardTypeAmountQuiz']").val("");
    	}
