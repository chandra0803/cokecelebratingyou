		  ...
		  <tr>
				...
				<table cellpadding="3" cellspacing="1" >							
					...
					<tr>
						<td class="subheadline" colspan="3">
							...
							&nbsp;&nbsp;
							<a href="javascript: setActionDispatchAndSubmit('userDisplay.do','prepareUpdatePersonalInfo');" class="content-link">
			...
			<td width="49%" valign="top">
				<table cellpadding="3" cellspacing="1" >	
			  	...
			  	<tr class="form-row-spacer" >
				   ...
				   <%-- END Web Site Information --%>
    				...
    				<tr>
						<td class="subheadline" colspan="4" nowrap>
							<cms:contentText key="HIERARCHY_HEADER" code="user.user"/>
							&nbsp;&nbsp;&nbsp;
							<%	pageContext.setAttribute("hierarchyUrl", ClientStateUtils.generateEncodedLink( RequestUtils.getBaseURI(request), "/participant/maintainUserNodes.do?method=displayList", parameterMap ) ); %>
							<a href="<c:out value="${hierarchyUrl}"/>" class="crud-content-link">
								<cms:contentText key="UPDATE" code="user.user"/>
							</a>
						</td>
					</tr>
				...
				<c:forEach items="${userForm.userNodes}" var="userNode">
					<tr>
						<td class="content-field-label"></td>
						<td class="content-bold" colspan="3">
