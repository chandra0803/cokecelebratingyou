...
<html:form styleId="contentForm" action="userMaintainCreate" focus="firstName">
...
<table border="0" cellpadding="10" cellspacing="0" width="100%">
    <tr>
      <td>
        <span class="headline"><cms:contentText key="TITLE_ADD_USER" code="user.user"/></span>
		  ...
		  <tr>
			<td width="49%" valign="top">
				<table cellpadding="3" cellspacing="1">							
					...
					<%-- Bug Fix 23605 end --%>
					<html:options collection="countryList" property="phoneCountryCode"
			...
			<td width="49%" valign="top">
		        ...
		        <td class="content-field">
			        ...
			        <tr class="form-row-spacer">
						<td class="subheadline" colspan="3">
							<cms:contentText key="HIERARCHY_HEADER" code="user.user"/>
						</td>
					</tr>
					
					 <tr class="form-row-spacer">				  
			            <beacon:label property="nameOfNode" required="true">
			             	<cms:contentText key="HIERARCHY_NODE" code="user.user"/>
			            </beacon:label>	
			            <td class="content-field" nowrap>
				            <html:text property="nameOfNode" size="30" styleClass="content-field"></html:text>
				            
							&nbsp;&nbsp;
							<a href="javascript: setActionDispatchAndSubmit('userDisplay.do','prepareNodeLookup');" class="content-link"><cms:contentText key="NODE_LOOKUP" code="user.user"/></a>
				        </td>              
          			</tr>								
			        
			        <tr class="form-row-spacer">				  
		              <beacon:label property="nodeRelationship" required="true">
		                <cms:contentText key="NODE_RELATIONSHIP" code="user.user"/>
		              </beacon:label>	
		              <td class="content-field">
