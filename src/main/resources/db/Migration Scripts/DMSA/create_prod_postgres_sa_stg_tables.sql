-- Service awards db
CREATE TABLE "DMSAPROD".stg_sa_persons as select * from persons where 1 = 2; 
CREATE TABLE "DMSAPROD".stg_sa_milestones as select * from milestones where 1 = 2; 
CREATE TABLE "DMSAPROD".stg_sa_recipients as select * from recipients where 1 = 2; 
CREATE TABLE "DMSAPROD".stg_sa_celebrationspersons as select * from celebrationspersons where 1 = 2; 
CREATE TABLE "DMSAPROD".stg_sa_programs
(
    id integer,
    companyid uuid,
    program_uuid uuid,
