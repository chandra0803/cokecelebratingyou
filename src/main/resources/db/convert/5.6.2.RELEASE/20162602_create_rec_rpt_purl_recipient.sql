...
(
  ...
  PROMOTION_NAME             VARCHAR2(90 BYTE),
  NODE_ID                    NUMBER(18),
  NODE_NAME                  VARCHAR2(255 BYTE),
  RECIPIENT_USER_ID          NUMBER(18),
  RECIPIENT_COUNTRY_ID       NUMBER(12),
  RECIPIENT_LAST_NAME        VARCHAR2(40 BYTE),
  RECIPIENT_FIRST_NAME       VARCHAR2(40 BYTE),
  RECIPIENT_USER_NAME        VARCHAR2(40 BYTE),
  RECIPIENT_EMAIL_ADDR       VARCHAR2(75 BYTE),
  RECIPIENT_PAX_STATUS       VARCHAR2(30 CHAR),
  RECIPIENT_JOB_POSITION     VARCHAR2(100 BYTE),
  RECIPIENT_DEPARTMENT       VARCHAR2(100 BYTE),
  AWARD_DATE                 DATE,
...
/
CREATE TABLE RPT_PURL_RECIPIENT_SUMMARY
(
  ...
  PROMOTION_ID              NUMBER(18),
  PURL_CREATED_DATE         DATE                NOT NULL,
  RECIPIENT_COUNT           NUMBER(18),
  JOB_POSITION              VARCHAR2(100 CHAR),
  DEPARTMENT                VARCHAR2(100 CHAR),
  CONTRIBUTION_POSTED       NUMBER(12),
  NUM_CONTRIBUTORS_INVITED  NUMBER(18),
  NUM_CONTRIBUTORS_ACTUAL   NUMBER(18),
  HIER_LEVEL                NUMBER,
  IS_LEAF                   NUMBER(1),
  DATE_CREATED              DATE                NOT NULL,
  CREATED_BY                NUMBER(18)          NOT NULL,
...
/
ALTER TABLE RPT_PURL_RECIPIENT_SUMMARY ADD (
  CONSTRAINT RPT_PURL_RECIPIENT_SUMMARY_PK
  PRIMARY KEY
