CREATE OR REPLACE FORCE VIEW SM_CP_PROMO_LAUNCH_NOTI_VW
(
   MAILING_ID,
   USER_ID,
   LOCALE,
...
AS
     SELECT r.mailing_id,
      ...
      WHERE m.batch_id is not null 
        ...
        AND d.data_key IN ( 'firstName','lastName' , 'programName' ,'challengepoint1',  'challengepointLevel1' ,  'challengepointValue1', 'challengepointReward1' ,'challengepoint2', 'challengepointLevel2' ,  'challengepointValue2' , 'challengepointReward2' ,'challengepoint3','challengepointLevel3' ,  'challengepointValue3' ,'challengepointReward3' ,'base','siteLink' , 'contactUsUrl' ,'registrationStartDate','registrationEndDate', 'promotionStartDate' , 'promotionEndDate' , 'points')
