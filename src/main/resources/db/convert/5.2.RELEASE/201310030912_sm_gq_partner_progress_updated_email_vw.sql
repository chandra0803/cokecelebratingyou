CREATE OR REPLACE FORCE VIEW SM_GQ_PART_PROG_UPD_VW
(
   MAILING_ID,
   USER_ID,
   LOCALE,
...
AS
     SELECT r.mailing_id,
      ...
      WHERE m.batch_id is not null 
        ...
        AND d.data_key IN ('partnerFirstName','partnerLastName', 'firstName', 'lastName', 'programName' , 'goalLevel' , 'goalLevelAmount' , 'totalGoalValue' , 'actualResults','percentToGoal','siteLink','date')
