CREATE OR REPLACE PROCEDURE prc_insert_stg_cp_base_data
   ( p_in_import_record IN stage_cp_base_data_import%ROWTYPE, 
...
*******************************************************************************/
  v_process_name          execution_log.process_name%type  := 'PRC_INSERT_STG_CP_BASE_DATA';
  v_release_level         execution_log.release_level%type := '1';


BEGIN
  INSERT INTO stage_cp_base_data_import
    (import_record_id,
     import_file_id,
     action_type,
     login_id,
  ...
  VALUES
    (p_in_import_record.import_record_id,
     ...
     p_in_import_record.base_objective,
