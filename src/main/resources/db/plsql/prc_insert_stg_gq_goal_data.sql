CREATE OR REPLACE 
PROCEDURE prc_insert_stg_gq_goal_data
   ( p_in_import_record IN stage_gq_goal_data_import%ROWTYPE, 
...
*******************************************************************************/
  ...
  v_process_name          execution_log.process_name%type  := 'PRC_INSERT_STG_GQ_GOAL_DATA';
  v_release_level         execution_log.release_level%type := '1';


BEGIN
  INSERT INTO stage_GQ_goal_data_import
    (import_record_id,
     import_file_id,
     action_type,
     login_id,
