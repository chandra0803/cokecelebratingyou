CREATE OR REPLACE function fnc_get_badge_date_count
(p_user_id IN NUMBER,
 p_module       IN VARCHAR2,
 start_date    IN DATE,
 end_date    IN DATE)--recognition/nomination/quiz/null
 RETURN NUMBER is
...
AND trunc(pb.date_created) between trunc(start_date) and trunc(end_date)
