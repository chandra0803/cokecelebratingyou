...
public class SSIObjContestImportStrategy extends BaseFileloadStrategy implements FileStageStrategy
{
  private static final String SSI_CONTEST_SR_FILE_IMPORT = "pkg_ssi_objective_load.p_ssi_objec_stg_verify_import";
