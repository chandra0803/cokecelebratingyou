...
public class CelebrationShareLinkValue implements Serializable
{
  ...
  public CelebrationShareLinkValue()
  {
    super();
  }

  public CelebrationShareLinkValue( String nameId, String name, String url )
  {
    super();
    this.nameId = nameId;
    this.url = url;
