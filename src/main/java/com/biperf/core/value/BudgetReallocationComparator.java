...
public class BudgetReallocationComparator implements Comparator<BudgetReallocationValueBean>
{
  /**
     ...
     *           Comparator.
     */
  public int compare( BudgetReallocationValueBean bean1, BudgetReallocationValueBean bean2 )
  {
    return bean1.getNodeName().compareTo( bean2.getNodeName() );
  }
}
