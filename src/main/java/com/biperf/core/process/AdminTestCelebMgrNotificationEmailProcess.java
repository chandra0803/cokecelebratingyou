...
public class AdminTestCelebMgrNotificationEmailProcess extends BaseProcessImpl
{

  private static final Log log = LogFactory.getLog( AdminTestCelebMgrNotificationEmailProcess.class );

  public static final String PROCESS_NAME = "Admin Test Celebration Manager Notification Email Process";
  public static final String BEAN_NAME = "adminTestCelebMgrNotificationEmailProcess";
  ...
  public AdminTestCelebMgrNotificationEmailProcess()
  {
    super();
  }
  ...
  public void onExecute()
  {
    ...
    {
      log.info( " The Process 'AdminTestCelebMgrNotificationEmailProcess' Has Been Restricted !!!!, Since The New Service Anniversary Has Been Enabled IN DM From Nackle Eco-System." );
      addComment( " The Process 'AdminTestCelebMgrNotificationEmailProcess' Has Been Restricted !!!!, Since The New Service Anniversary Has Been Enabled IN DM From Nackle Eco-System." );

    }
    else
    {
      log.debug( "Starting Admin Test Celebration Manager Notification Email Process with Manager User Name: " + managerUserName );
      try
      {
        Participant manager = participantService.getParticipantByUserName( managerUserName );
        if ( manager != null )
        {
          Message celebrationManagerMessage = messageService.getMessageByCMAssetCode( MessageService.CELEBRATION_MANAGER_NOTIFICATION_MESSAGE_CM_ASSET_CODE );
          ...
          /* normally sent by MailingServiceImpl.buildCelebrationManagerMailingRecipient */
