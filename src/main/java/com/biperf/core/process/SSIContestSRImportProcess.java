...
public class SSIContestSRImportProcess extends BaseProcessImpl
{

  public static final String BEAN_NAME = "ssicontestSRImportProcess";
  public static final String MESSAGE_NAME = "SSI Contest SR - Import Process";

  private ImportService importService;

  String importFileId;

  private static final Log log = LogFactory.getLog( SSIContestSRImportProcess.class );
  ...
  private void sendSummaryMessage( boolean success )
  {
    ...
    Mailing mailing = composeMail( MessageService.SSI_CONTEST_SR_IMPORT_PROCESS_MESSAGE_CM_ASSET_CODE, MailingType.PROCESS_EMAIL );
