 ...
 * $Source: /usr/local/ndscvsroot/products/penta-g/src/java/com/biperf/core/process/CPProgressImportProcess.java,v $
 */
 ...
 *
 */
public class CPProgressImportProcess extends BaseProcessImpl
{
  public static final String BEAN_NAME = "cpProgressImportProcess";
  public static final String MESSAGE_NAME = "Challengepoint Progress Import Process";
   ...
   */
  private static final Log log = LogFactory.getLog( CPProgressImportProcess.class );
  ...
  private void sendSummaryMessage()
  {
    ...
    // Compose the mailing
    Mailing mailing = composeMail( MessageService.CPPROGRESS_IMPORT_PROCESS_MESSAGE_CM_ASSET_CODE, MailingType.PROCESS_EMAIL );
