...
public class BudgetDistributionImportProcess extends BaseProcessImpl
{

  public static final String BEAN_NAME = "budgetDistributionImportProcess";
  public static final String MESSAGE_NAME = "Budget Distribution Import Process";
   ...
   */
  private static final Log log = LogFactory.getLog( BudgetDistributionImportProcess.class );
  ...
  private void sendSummaryMessage( boolean success )
  {
    ...
    // Compose the mailing
    Mailing mailing = composeMail( MessageService.BUDGET_REDISTRIBUTION_IMPORT_PROCESS_MESSAGE_CM_ASSET_CODE, MailingType.PROCESS_EMAIL );
