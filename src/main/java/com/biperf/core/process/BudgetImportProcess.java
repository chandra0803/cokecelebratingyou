 ...
 * $Source: /usr/local/ndscvsroot/products/penta-g/src/java/com/biperf/core/process/BudgetImportProcess.java,v $
 */
 ...
 *
 */
public class BudgetImportProcess extends BaseProcessImpl
{
  public static final String BEAN_NAME = "budgetImportProcess";
  public static final String MESSAGE_NAME = "Budget Import Process";
   ...
   */
  private static final Log log = LogFactory.getLog( BudgetImportProcess.class );
  ...
  private void sendSummaryMessage()
  {
    ...
    // Compose the mailing
    Mailing mailing = composeMail( MessageService.BUDGET_IMPORT_PROCESS_MESSAGE_CM_ASSET_CODE, MailingType.PROCESS_EMAIL );
