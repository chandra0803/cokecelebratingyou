...
public class SSIContestSIUImportProcess extends BaseProcessImpl
{

  public static final String BEAN_NAME = "ssicontestSIUImportProcess";
  public static final String MESSAGE_NAME = "SSI Contest SIU - Import Process";

  private ImportService importService;

  String importFileId;

  private static final Log log = LogFactory.getLog( SSIContestSIUImportProcess.class );
  ...
  private void sendSummaryMessage( boolean success )
  {
    ...
    Mailing mailing = composeMail( MessageService.SSI_CONTEST_SIU_IMPORT_PROCESS_MESSAGE_CM_ASSET_CODE, MailingType.PROCESS_EMAIL );
