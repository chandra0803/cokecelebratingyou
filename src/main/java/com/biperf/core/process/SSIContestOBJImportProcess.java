...
public class SSIContestOBJImportProcess extends BaseProcessImpl
{

  public static final String BEAN_NAME = "ssicontestOBJImportProcess";
  public static final String MESSAGE_NAME = "SSI Contest OBJ - Import Process";

  private ImportService importService;

  String importFileId;

  private static final Log log = LogFactory.getLog( SSIContestOBJImportProcess.class );
  ...
  private void sendSummaryMessage( boolean success )
  {
    ...
    Mailing mailing = composeMail( MessageService.SSI_CONTEST_OBJ_IMPORT_PROCESS_MESSAGE_CM_ASSET_CODE, MailingType.PROCESS_EMAIL );
