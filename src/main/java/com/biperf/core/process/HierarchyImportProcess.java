 ...
 * $Source: /usr/local/ndscvsroot/products/penta-g/src/java/com/biperf/core/process/HierarchyImportProcess.java,v $
 */
 ...
 *
 */
public class HierarchyImportProcess extends BaseProcessImpl
{
  public static final String BEAN_NAME = "hierarchyImportProcess";
  public static final String MESSAGE_NAME = "Hierarchy Import Process";
   ...
   */
  private static final Log log = LogFactory.getLog( HierarchyImportProcess.class );
  ...
  private void sendSummaryMessage( boolean success )
  {
    ...
    // Compose the mailing
    Mailing mailing = composeMail( MessageService.HIERARCHY_IMPORT_PROCESS_MESSAGE_CM_ASSET_CODE, MailingType.PROCESS_EMAIL );
