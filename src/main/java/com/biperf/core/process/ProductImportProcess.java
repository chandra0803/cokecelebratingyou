 ...
 * $Source: /usr/local/ndscvsroot/products/penta-g/src/java/com/biperf/core/process/ProductImportProcess.java,v $
 */
 ...
 *
 */
public class ProductImportProcess extends BaseProcessImpl
{
  public static final String BEAN_NAME = "productImportProcess";
  public static final String MESSAGE_NAME = "Product Import Process";
   ...
   */
  private static final Log log = LogFactory.getLog( ProductImportProcess.class );
  ...
  private void sendSummaryMessage()
  {
    ...
    // Compose the mailing
    Mailing mailing = composeMail( MessageService.PRODUCT_IMPORT_PROCESS_MESSAGE_CM_ASSET_CODE, MailingType.PROCESS_EMAIL );
