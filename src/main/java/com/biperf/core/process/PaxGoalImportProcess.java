...
public class PaxGoalImportProcess extends BaseProcessImpl
{
  public static final String BEAN_NAME = "paxGoalImportProcess";
  public static final String MESSAGE_NAME = "GoalQuest Pax Goal Import Process";
   ...
   */
  private static final Log log = LogFactory.getLog( PaxGoalImportProcess.class );
  ...
  private void sendSummaryMessage()
  {
    ...
    // Compose the mailing
    Mailing mailing = composeMail( MessageService.PAXGOAL_IMPORT_PROCESS_MESSAGE_CM_ASSET_CODE, MailingType.PROCESS_EMAIL );
