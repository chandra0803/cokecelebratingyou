...
public class NominationCustomApproverProcess extends BaseProcessImpl
{

  public static final String BEAN_NAME = "nominationCustomApproverProcess";
  public static final String MESSAGE_NAME = "Nomination custom approver - Import Process";

  private ImportService importService;

  String importFileId;

  private static final Log log = LogFactory.getLog( NominationCustomApproverProcess.class );
  ...
  private void sendSummaryMessage( boolean success )
  {
    ...
    Mailing mailing = composeMail( MessageService.NOMINATION_CUSTOM_APPROVER_IMPORT_PROCESS_MESSAGE_CM_ASSET_CODE, MailingType.PROCESS_EMAIL );
