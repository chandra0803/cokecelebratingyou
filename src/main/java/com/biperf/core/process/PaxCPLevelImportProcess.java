...
public class PaxCPLevelImportProcess extends BaseProcessImpl
{
  public static final String BEAN_NAME = "paxCPLevelImportProcess";
  public static final String MESSAGE_NAME = "Challengepoint Pax Level Import Process";
   ...
   */
  private static final Log log = LogFactory.getLog( PaxCPLevelImportProcess.class );
  ...
  private void sendSummaryMessage()
  {
    ...
    // Compose the mailing
    Mailing mailing = composeMail( MessageService.PAXCPLEVEL_IMPORT_PROCESS_MESSAGE_CM_ASSET_CODE, MailingType.PROCESS_EMAIL );
