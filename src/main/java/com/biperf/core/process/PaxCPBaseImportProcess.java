...
public class PaxCPBaseImportProcess extends BaseProcessImpl
{
  public static final String BEAN_NAME = "paxCPBaseImportProcess";
  public static final String MESSAGE_NAME = "Challengepoint Pax Base Import Process";
   ...
   */
  private static final Log log = LogFactory.getLog( PaxCPBaseImportProcess.class );
  ...
  private void sendSummaryMessage()
  {
    ...
    // Compose the mailing
    Mailing mailing = composeMail( MessageService.PAXCPBASE_IMPORT_PROCESS_MESSAGE_CM_ASSET_CODE, MailingType.PROCESS_EMAIL );
