 ...
 * $Source: /usr/local/ndscvsroot/products/penta-g/src/java/com/biperf/core/process/DepositImportProcess.java,v $
 */
 ...
 *
 */
public class DepositImportProcess extends BaseProcessImpl
{
  public static final String BEAN_NAME = "depositImportProcess";
  public static final String MESSAGE_NAME = "Deposit Import Process";
   ...
   */
  private static final Log log = LogFactory.getLog( DepositImportProcess.class );
  ...
  private void sendSummaryMessage()
  {
    ...
    objectMap.put( "errors", String.valueOf( importFile.getImportRecordErrorCount() ) );
    ...
    // Compose the mailing
    Mailing mailing = composeMail( MessageService.DEPOSIT_IMPORT_PROCESS_MESSAGE_CM_ASSET_CODE, MailingType.PROCESS_EMAIL );
