...
public class SSIContestATNImportProcess extends BaseProcessImpl
{

  public static final String BEAN_NAME = "ssicontestATNImportProcess";
  public static final String MESSAGE_NAME = "SSI Contest ATN - Import Process";

  private ImportService importService;

  String importFileId;

  private static final Log log = LogFactory.getLog( SSIContestATNImportProcess.class );
  ...
  private void sendSummaryMessage( boolean success )
  {
    ...
    Mailing mailing = composeMail( MessageService.SSI_CONTEST_ATN_IMPORT_PROCESS_MESSAGE_CM_ASSET_CODE, MailingType.PROCESS_EMAIL );
