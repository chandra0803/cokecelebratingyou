...
public class BadgeRuleComparator implements Comparator
{
  ...
  {
    if ( ! ( o1 instanceof BadgeRule ) || ! ( o2 instanceof BadgeRule ) )
    {
      throw new ClassCastException( "Object is not a BadgeRule object!" );
    }
    BadgeRule badgeRule1 = (BadgeRule)o1;
    BadgeRule badgeRule2 = (BadgeRule)o2;

    Integer bean1Id = new Integer( badgeRule1.getId().toString() );
    Integer bean2Id = new Integer( badgeRule2.getId().toString() );

    return ( (Comparable)bean1Id ).compareTo( bean2Id );
  }
}
