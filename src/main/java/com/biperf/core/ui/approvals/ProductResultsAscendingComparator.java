 ...
 *
 */
public class ProductResultsAscendingComparator implements Comparator
{
  @Override
  public int compare( Object o1, Object o2 )
  {
    ...
    if ( result1 != null && result2 != null )
    {
      ...
      {
        return result1.getProductsList().get( 0 ).getApprover().toUpperCase().compareTo( result2.getProductsList().get( 0 ).getApprover().toUpperCase() );
      }
    }
    return 0;
  }
