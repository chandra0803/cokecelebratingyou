 ...
 * @since Feb 11, 2016
 */
public class NominationPromotionLevelBean implements Serializable
{
  ...
  private Long eachLevelCalculatorId;
  ...
  public Long getEachLevelCalculatorId()
  {
    return eachLevelCalculatorId;
  }

  public void setEachLevelCalculatorId( Long eachLevelCalculatorId )
  {
    this.eachLevelCalculatorId = eachLevelCalculatorId;
  }
