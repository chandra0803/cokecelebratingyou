 ...
 * $Source: /usr/local/ndscvsroot/products/penta-g/src/javaui/com/biperf/core/ui/BaseForm.java,v $
 */
...
/*
 * BaseForm is the base ActionForm object. Technically, this is a ValidatorForm. <p> <b>Change
...
public class BaseForm extends ValidatorForm
{
  ...
  {
    setClientState( clientState, this );
  }

  /**
   * Sets the client state and, in addition, sets the value of properties of the given bean based on the
   * given client state.
   * 
   * @param clientState an encrypted, base-64 encoded version of the serialized values of some or
   *          all of the properties of this form.
   */
  public void setClientState( String clientState, Object bean )
  {
    ...
    if ( clientState != null )
    {
      try
      {
        ...
        BeanUtils.populate( bean, clientStateMap );
      }
