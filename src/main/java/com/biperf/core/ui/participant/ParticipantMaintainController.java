 ...
 *
 */
public class ParticipantMaintainController extends BaseAdminUserController
{
  private static final Log LOG = LogFactory.getLog( ParticipantMaintainController.class );
