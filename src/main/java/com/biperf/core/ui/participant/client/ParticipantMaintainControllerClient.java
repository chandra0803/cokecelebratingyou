 ...
 * $Source: /usr/local/ndscvsroot/products/penta-g/src/javaui/com/biperf/core/ui/participant/ParticipantMaintainControllerClient.java,v $
 */

package com.biperf.core.ui.participant.client;
...
/* ************************************************************************
 * 
 * ParticipantMaintainControllerClient.
 * 
 * @author bethke
 * @since Aug 30, 2019
 * @version 1.0
 ...
 * Created to tune client-facing screens. Admin screens use ParticipantMaintainController.
 ************************************************************************ */
public class ParticipantMaintainControllerClient extends BaseController
{
  private static final Log LOG = LogFactory.getLog( ParticipantMaintainControllerClient.class );
  ...
  public void onExecute( ComponentContext componentContext, HttpServletRequest request, HttpServletResponse response, ServletContext servletContext ) throws Exception
  {
    ...
    //request.setAttribute( "requirePostalCode", new Boolean( requirePostalCodeByCountryCode( participantForm.getAddressFormBean().getCountryCode(), getAllCountryList() ) ) );
...
/*
    ...
    if ( participantForm.getUserCharacteristicValueListCount() > 0 )
    {
      CharacteristicUtils.loadExistingValues( characteristicList, participantForm.getUserCharacteristicValueList() );
    }
    participantForm.setUserCharacteristicValueList( characteristicList );
