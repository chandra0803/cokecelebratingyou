...
public class GoalQuestManagerReportAction extends GoalQuestReportAction
{
  ...
  {
    return Report.GOAL_QUEST_MANAGER;
  }
  ...
  public ActionForward displaySummaryReport( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response ) throws ServiceErrorException
  {
    ...
    {
      Map<String, Object> resultsMap = getGoalQuestReportsService().getGoalQuestManagerTabularResults( reportParameters );
      List<GoalQuestManagerReportValue> reportData = (List<GoalQuestManagerReportValue>)resultsMap.get( OUTPUT_DATA );

      Integer maxRows = (Integer)resultsMap.get( OUTPUT_SIZE_DATA );

      if ( isLastPage( maxRows, reportParameters ) )
      {
        GoalQuestManagerReportValue totalsRowData = (GoalQuestManagerReportValue)resultsMap.get( OUTPUT_TOTALS_DATA );
    ...
    return mapping.findForward( "display_goal_quest_manager_summary" );
  }
  ...
  public ActionForward displayDetailReport( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response ) throws ServiceErrorException
  {
    ...
    Map<String, Object> resultsMap = getGoalQuestReportsService().getGoalQuestManagerDetailTabularResults( reportParameters );
    List<GoalQuestManagerReportValue> reportData = (List<GoalQuestManagerReportValue>)resultsMap.get( OUTPUT_DATA );
    ...
    request.setAttribute( "reportData", reportData );
    return mapping.findForward( "display_goal_quest_manager_detail" );
  }
  ...
  public ActionForward displayTotalPointsEarnedChart( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response ) throws ServiceErrorException
  {
    ...
    Map<String, Object> resultsMap = getGoalQuestReportsService().getManagerTotalPointsEarnedChart( reportParameters );
    List<GoalQuestManagerReportValue> reportData = (List<GoalQuestManagerReportValue>)resultsMap.get( OUTPUT_DATA );
    request.setAttribute( "reportData", reportData );
  ...
  protected String getExtractReportData( Map<String, Object> extractParameters )
  {
    ...
    Map output = getGoalQuestReportsService().getGoalQuestManagerAchievementExtractReport( extractParameters );
  ...
  {
    return ReportBeanMethod.GQ_MANAGER_ACHIEVEMENT_REPORT;
  }
