...
public class GoalQuestProgressReportAction extends GoalQuestReportAction
{
  ...
  {
    return Report.GOAL_QUEST_PROGRESS;
  }
  ...
  public ActionForward displaySummaryReport( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response ) throws ServiceErrorException
  {
    ...
    {
      Map<String, Object> resultsMap = getGoalQuestReportsService().getGoalQuestProgressTabularResults( reportParameters );
      List<GoalQuestProgressReportValue> reportData = (List<GoalQuestProgressReportValue>)resultsMap.get( OUTPUT_DATA );
      ...
      {
        GoalQuestProgressReportValue totalsRowData = (GoalQuestProgressReportValue)resultsMap.get( OUTPUT_TOTALS_DATA );
    ...
    return mapping.findForward( "display_goal_quest_progress_summary" );
  }
  ...
  public ActionForward displayDetailReport( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response ) throws ServiceErrorException
  {
    ...
    Map<String, Object> resultsMap = getGoalQuestReportsService().getGoalQuestProgressDetailResults( reportParameters );
    List<GoalQuestProgressReportValue> reportData = (List<GoalQuestProgressReportValue>)resultsMap.get( OUTPUT_DATA );
    request.setAttribute( "reportData", reportData );
    ...
    return mapping.findForward( "display_goal_quest_progress_detail" );
  }
  ...
  public ActionForward displayProgressToGoalChart( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response ) throws ServiceErrorException
  {
    ...
    Map<String, Object> resultsMap = getGoalQuestReportsService().getProgressToGoalChart( reportParameters );
    GoalQuestProgressReportValue reportData = (GoalQuestProgressReportValue)resultsMap.get( OUTPUT_DATA );
    request.setAttribute( "reportData", reportData );
    return mapping.findForward( "display_goal_quest_goalprogress_chart" );
  }
  ...
  {
    Map<String, Object> reportParameters = prepareChartDisplay( mapping, form, request, response );
    Map<String, Object> resultsMap = getGoalQuestReportsService().getGoalQuestProgressResultsChart( reportParameters );
    List<GoalQuestProgressReportValue> reportData = (List<GoalQuestProgressReportValue>)resultsMap.get( OUTPUT_DATA );
    request.setAttribute( "reportData", reportData );

    return mapping.findForward( "display_goal_quest_progressresults_chart" );
  }
  ...
  protected String getExtractReportData( Map<String, Object> reportParameters )
  {
    ...
    Map reportExtractData = getGoalQuestReportsService().getGoalQuestProgressExtractResults( reportParameters );
  ...
  {
    return ReportBeanMethod.GQ_PROGRESS_REPORT;
  }
