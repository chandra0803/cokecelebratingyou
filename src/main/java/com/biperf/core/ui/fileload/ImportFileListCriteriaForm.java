 ...
 * $Source: /usr/local/ndscvsroot/products/beacon/src/javaui/com/biperf/core/ui/fileload/ImportFileListCriteriaForm.java,v $
 */
...
public class ImportFileListCriteriaForm extends BaseForm
{
  // ---------------------------------------------------------------------------
  // Fields
  // ---------------------------------------------------------------------------

  private static final Log log = LogFactory.getLog( ImportFileListCriteriaForm.class );
