...
/**
 * RecognitionAwardsLevelController.
 * <p>
 ...
 * 
 */
public class RecognitionAwardsLevelController extends BaseController
{
  // ---------------------------------------------------------------------------
  // Fields
  // ---------------------------------------------------------------------------
  ...
  public void onExecute( ComponentContext tileContext, HttpServletRequest request, HttpServletResponse response, ServletContext servletContext )
  {
    ...
    if ( !StringUtils.isEmpty( promoId ) )
    {
      ...
      RecognitionAwardsLevelForm recognitionOptionsForm = (RecognitionAwardsLevelForm)request.getAttribute( "recognitionAwardsLevelForm" );
      ...
      // display the comments section if STAGE_AWARD_LEVEL_IMPORT does not have comments.
      ...
      {
        ImportFile optionsImportFile = (ImportFile)request.getSession().getAttribute( "recAwardsImportFile" );
