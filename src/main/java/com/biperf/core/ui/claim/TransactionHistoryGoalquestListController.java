 ...
 * $Source: /usr/local/ndscvsroot/products/penta-g/src/javaui/com/biperf/core/ui/claim/TransactionHistoryGoalquestListController.java,v $
 */
...
/**
 * TransactionHistoryGoalquestListController
 * <p>
 ...
 *          Exp $
 */
public class TransactionHistoryGoalquestListController extends TransactionHistoryClaimListController
{
  ...
  public void onExecute( ComponentContext tileContext, HttpServletRequest request, HttpServletResponse response, ServletContext servletContext )
  {
    ...
    valueObjects = getJournalList( promotionId, participantId, promotionType );
    tileContext.putAttribute( "transactionList", "/claim/goalquestTransactionList.jsp" );
  ...
  private List getJournalList( Long promotionId, Long participantId, String promotionType )
  {
    ...
    queryConstraint.setJournalTypesIncluded( new String[] { Journal.AWARD } );
    queryConstraint.setPromotionType( promotionType );
    ...
    for ( Iterator iter = journalList.iterator(); iter.hasNext(); )
    {
      ...
      GoalquestHistoryValueObject valueObject = new GoalquestHistoryValueObject();
