 ...
 *
 */
public class SHA256HashSeamless
{
  private static final Log LOG = LogFactory.getLog( SHA256HashSeamless.class );

  public static String ALGORITHM_PREFIX = "{SHA}";
