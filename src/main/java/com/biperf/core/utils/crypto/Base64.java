...
public class Base64
{
  ...
  private static final byte[] _NATIVE_ALPHABET = { (byte)'A',
                                                   (byte)'B',
                                                   (byte)'C',
                                                   (byte)'D',
                                                   (byte)'E',
   ...
   */
  private static final byte[] DECODABET = { -9,
                                            -9,
                                            -9,
                                            -9,
                                            -9,
  ...
  private static int decode4to3( byte[] source, int srcOffset, byte[] destination, int destOffset )
  {
    ...
    else
    {
      ...
      {
        log.error( "" + source[srcOffset] + ": " + DECODABET[source[srcOffset]] + "" + source[srcOffset + 1] + ": " + DECODABET[source[srcOffset + 1]] + "" + source[srcOffset + 2] + ": "
