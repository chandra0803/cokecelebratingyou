...
public class CallPrcBunchballActivity extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PRC_ADIH_BB_ACTIVITY";

  public CallPrcBunchballActivity( DataSource ds )
  {
