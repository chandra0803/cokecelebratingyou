...
public class CallPrcBunchballUsers extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PRC_ADIH_BB_USERS";

  public CallPrcBunchballUsers( DataSource ds )
  {
