...
public class CallGenerateBudgetFileProc extends StoredProcedure
{
	private static final String STORED_PROC_NAME = "PRC_ADIH_GENERATE_BUDGET";
	public CallGenerateBudgetFileProc( DataSource ds )
	  {
