...
/**
 * 
 * CallPrcEngagementUniqueRecognitionsOrgChart.
 * 
 * @author kandhi
 * @since Jul 23, 2014
 * @version 1.0
 */
public class CallPrcEngagementUniqueRecognitionsOrgChart extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_ENGAGEMENT.PRC_ENG_RECOG_BYORG_CHART";

  public CallPrcEngagementUniqueRecognitionsOrgChart( DataSource ds )
  {
  ...
  private class EngagementChartDataExtractor implements ResultSetExtractor
  {
    ...
    public List<EngagementChartValueBean> extractData( ResultSet rs ) throws SQLException, DataAccessException
    {
      ...
      while ( rs.next() )
      {
        ...
        engagementChartValueBean.setLabel( rs.getString( "node_name" ) );
