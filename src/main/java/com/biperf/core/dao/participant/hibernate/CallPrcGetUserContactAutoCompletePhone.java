 ...
 * This is the variant for when a phone number was picked from the initial search
 */
public class CallPrcGetUserContactAutoCompletePhone extends StoredProcedure
{

  private static final String STORED_PROC_NAME = "prc_get_user_autocomp_by_phone";
  ...
  public CallPrcGetUserContactAutoCompletePhone( DataSource ds )
  {
  ...
  public Map<String, Object> executeProcedure( String phoneNumber, String searchString )
  {
