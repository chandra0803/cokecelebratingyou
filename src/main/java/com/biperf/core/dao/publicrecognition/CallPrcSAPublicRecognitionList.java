...
public class CallPrcSAPublicRecognitionList extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_LIST_RECOGNITION_WALL.PRC_LIST_RECOGNITION_WALL_SA";

  public CallPrcSAPublicRecognitionList( DataSource ds )
  {
    ...
    declareParameter( new SqlOutParameter( "p_out_result_set_recipients", OracleTypes.CURSOR, new CallPrcSAPublicRecognitionList.RecipientsResultSetExtractor() ) );
    declareParameter( new SqlOutParameter( "p_out_result_set_pub_likes", OracleTypes.CURSOR, new CallPrcSAPublicRecognitionList.PublicLikesResultSetExtractor() ) );
    declareParameter( new SqlOutParameter( "p_out_result_set_pub_comments", OracleTypes.CURSOR, new CallPrcSAPublicRecognitionList.PublicCommentsResultSetExtractor() ) );
    // adding new cursor for badge ref
    declareParameter( new SqlOutParameter( "p_out_result_set_badge", OracleTypes.CURSOR, new CallPrcSAPublicRecognitionList.PublicBadgesResultSetExtractor() ) );
  ...
  private class PublicRecognitionResultSetExtractor implements ResultSetExtractor
  {
    ...
    public List<PublicRecognitionFormattedValueBean> extractData( ResultSet rsPublicRecognitions ) throws SQLException, DataAccessException
    {
      ...
      while ( rsPublicRecognitions.next() )
      {
        ...
        pubRecBean.setRecognitionSequence( rsPublicRecognitions.getLong( "rec_seq" ) );
        pubRecBean.setPrimaryColor( rsPublicRecognitions.getString( "primary_color" ) );
        pubRecBean.setSecondaryColor( rsPublicRecognitions.getString( "secondary_color" ) );
        pubRecBean.setCelebImgDesCmxAssetCode( rsPublicRecognitions.getString( "celeb_img_desc_cmx_asset_code" ) );
        pubRecBean.setCelebMsgCmxAssetCode( rsPublicRecognitions.getString( "celeb_msg_cmx_asset_code" ) );
        pubRecBean.setCelebMessage( rsPublicRecognitions.getString( "celeb_msg" ) );
        pubRecBean.setCelebImgDesc( rsPublicRecognitions.getString( "celeb_img_desc" ) );
        pubRecBean.setProgramHeader( rsPublicRecognitions.getString( "program_header" ) );
        pubRecBean.setProgramHeaderCmxCode( rsPublicRecognitions.getString( "program_header_cmx_asset_code" ) );
        pubRecBean.setUniqueId( rsPublicRecognitions.getLong( "unique_id" ) );
        pubRecBean.setCelebrationId( rsPublicRecognitions.getString( "celebration_id" ) );
        pubRecBean.setCelebImageUrl( rsPublicRecognitions.getString( "card_image_name" ) );
        pubRecBean.setProgramNameCmxCode( rsPublicRecognitions.getString( "program_name_cmx_asset_code" ) );
  ...
  private class RecipientsResultSetExtractor implements ResultSetExtractor
  {
    ...
    public List<PublicRecognitionParticipantView> extractData( ResultSet rsRecipients ) throws SQLException, DataAccessException
    {
      ...
      while ( rsRecipients.next() )
      {
        ...
        recipient.setDepartmentName( rsRecipients.getString( "position_type" ) != null ? DepartmentType.lookup( rsRecipients.getString( "department_type" ) ).getName() : "" );
