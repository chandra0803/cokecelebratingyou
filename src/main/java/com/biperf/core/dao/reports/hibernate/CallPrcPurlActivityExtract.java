...
public class CallPrcPurlActivityExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_PURL_EXTRACT";

  public CallPrcPurlActivityExtract( DataSource ds )
  {
    ...
    declareParameter( new SqlOutParameter( "p_out_result_set", OracleTypes.CURSOR, new CallPrcPurlActivityExtract.DataMapper() ) );
