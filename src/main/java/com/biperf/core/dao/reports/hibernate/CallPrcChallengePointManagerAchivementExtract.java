 ...
 *
 */
public class CallPrcChallengePointManagerAchivementExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_CP_MGR_ACHIEVE_EXTRACT";

  public CallPrcChallengePointManagerAchivementExtract( DataSource ds )
  {
    ...
    declareParameter( new SqlOutParameter( "p_out_result_set", OracleTypes.CURSOR, new CallPrcChallengePointManagerAchivementExtract.DataMapper() ) );
