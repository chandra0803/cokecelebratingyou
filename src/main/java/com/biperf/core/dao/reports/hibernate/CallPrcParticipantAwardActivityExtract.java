 ...
 *
 */
public class CallPrcParticipantAwardActivityExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_AWARD_ACTIVITY_EXTRACT";

  public CallPrcParticipantAwardActivityExtract( DataSource ds )
  {
    ...
    declareParameter( new SqlOutParameter( "p_out_result_set", OracleTypes.CURSOR, new CallPrcParticipantAwardActivityExtract.DataMapper() ) );
  ...
  public Map executeProcedure( Map<String, Object> reportParameters )
  {
    ...
    inParams.put( "p_in_status", reportParameters.get( "awardStatus" ) );
