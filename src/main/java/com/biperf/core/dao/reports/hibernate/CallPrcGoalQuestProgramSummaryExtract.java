 ...
 *
 */
public class CallPrcGoalQuestProgramSummaryExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_GQ_PROGRAM_SUMMARY_EXTRACT";

  public CallPrcGoalQuestProgramSummaryExtract( DataSource ds )
  {
    ...
    declareParameter( new SqlOutParameter( "p_out_result_set", OracleTypes.CURSOR, new CallPrcGoalQuestProgramSummaryExtract.DataMapper() ) );
