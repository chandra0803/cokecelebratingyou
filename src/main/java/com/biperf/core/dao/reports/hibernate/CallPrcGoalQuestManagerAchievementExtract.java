 ...
 *
 */
public class CallPrcGoalQuestManagerAchievementExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_GQ_MGR_ACHIEVE_EXTRACT";

  public CallPrcGoalQuestManagerAchievementExtract( DataSource ds )
  {
    ...
    declareParameter( new SqlOutParameter( "p_out_result_set", OracleTypes.CURSOR, new CallPrcGoalQuestManagerAchievementExtract.DataMapper() ) );
