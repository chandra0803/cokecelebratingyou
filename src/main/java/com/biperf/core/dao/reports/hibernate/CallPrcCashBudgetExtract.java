...
public class CallPrcCashBudgetExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_CASH_BUDGET_SUMARY_EXTRACT";

  public CallPrcCashBudgetExtract( DataSource ds )
  {
