 ...
 * $Source: /usr/local/ndscvsroot/products/penta-g/src/java/com/biperf/core/dao/reports/ChallengePointReportsDAO.java,v $
 *
 */
 ...
 * 
 */
public interface ChallengePointReportsDAO extends DAO
{
  /** ApplicationContext beanName */
  public static final String BEAN_NAME = "challengePointReportsDAO";
  ...
  // =======================================
  // CHALLENGE POINT SELECTION REPORT
  // =======================================
  ...
  // =======================================
  // CHALLENGE POINT EXTRACT REPORTS
  // =======================================
