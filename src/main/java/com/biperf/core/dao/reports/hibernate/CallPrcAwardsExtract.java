...
public class CallPrcAwardsExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_AWARDS_EXTRACT";

  public CallPrcAwardsExtract( DataSource ds )
  {
    ...
    declareParameter( new SqlParameter( "receivedAwardType", Types.VARCHAR ) );
    declareParameter( new SqlParameter( "IsOnTheSpotIncluded", Types.VARCHAR ) );
  ...
  public Map executeProcedure( Map<String, Object> reportParameters )
  {
    ...
    inParams.put( "receivedAwardType", reportParameters.get( "receivedAwardType" ) );
    inParams.put( "IsOnTheSpotIncluded", reportParameters.get( "onTheSpotIncluded" ) );
