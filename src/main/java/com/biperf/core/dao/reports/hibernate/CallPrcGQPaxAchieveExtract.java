 ...
 *
 */
public class CallPrcGQPaxAchieveExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_GQ_PAX_ACHIEVE_EXTRACT";

  public CallPrcGQPaxAchieveExtract( DataSource ds )
  {
    ...
    declareParameter( new SqlOutParameter( "p_out_result_set", OracleTypes.CURSOR, new CallPrcGQPaxAchieveExtract.DataMapper() ) );
