...
public class CallPrcSurveyOpenEndedExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_SURVEY_OPENEND_EXTRACT";

  public CallPrcSurveyOpenEndedExtract( DataSource ds )
  {
