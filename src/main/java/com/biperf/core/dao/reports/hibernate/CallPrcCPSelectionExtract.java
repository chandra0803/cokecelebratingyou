...
public class CallPrcCPSelectionExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_CP_SELECTION_EXTRACT";

  public CallPrcCPSelectionExtract( DataSource ds )
  {
    ...
    declareParameter( new SqlParameter( "p_in_has_select", Types.VARCHAR ) );
    ...
    declareParameter( new SqlOutParameter( "p_out_result_set", OracleTypes.CURSOR, new CallPrcCPSelectionExtract.DataMapper() ) );
  ...
  public Map executeProcedure( Map<String, Object> reportParameters )
  {
    ...
    inParams.put( "p_in_has_select", reportParameters.get( "hasSelected" ) );
