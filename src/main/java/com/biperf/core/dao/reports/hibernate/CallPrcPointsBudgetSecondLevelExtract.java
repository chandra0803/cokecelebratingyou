...
public class CallPrcPointsBudgetSecondLevelExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_POINT_BUDGET_SMDTL_EXTRACT";

  public CallPrcPointsBudgetSecondLevelExtract( DataSource ds )
  {
