...
public class CallPrcCashBudgetIssuanceExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_CASH_BUDGET_ISSU_EXTRACT";

  public CallPrcCashBudgetIssuanceExtract( DataSource ds )
  {
