 ...
 * $Source: /usr/local/ndscvsroot/products/penta-g/src/java/com/biperf/core/dao/reports/RecognitionReportsDAO.java,v $
 *
 */
 ...
 * 
 */
public interface RecognitionReportsDAO extends DAO
{
  /** ApplicationContext beanName */
  public static final String BEAN_NAME = "recognitionReportsDAO";
