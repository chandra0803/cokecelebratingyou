...
public class CallPrcNominationAgingSummaryExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_NOMI_AGING_SUM_EXTRACT";

  public CallPrcNominationAgingSummaryExtract( DataSource ds )
  {
    ...
    declareParameter( new SqlOutParameter( "p_out_result_set", OracleTypes.CURSOR, new CallPrcNominationAgingSummaryExtract.DataMapper() ) );
