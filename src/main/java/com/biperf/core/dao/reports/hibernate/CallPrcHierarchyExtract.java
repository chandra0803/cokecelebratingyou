...
public class CallPrcHierarchyExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_HIERARCHY_EXTRACT";

  public CallPrcHierarchyExtract( DataSource ds )
  {
