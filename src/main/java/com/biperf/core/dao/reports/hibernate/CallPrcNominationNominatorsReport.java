 ...
 *
 */
public class CallPrcNominationNominatorsReport extends StoredProcedure
{

  public CallPrcNominationNominatorsReport( DataSource ds, String STORED_PROC_NAME )
  {
    ...
    declareParameter( new SqlOutParameter( "p_out_data", OracleTypes.CURSOR, new CallPrcNominationNominatorsReport.NominationGiverNominatorsListMapper() ) );
    declareParameter( new SqlOutParameter( "p_out_totals_data", OracleTypes.CURSOR, new CallPrcNominationNominatorsReport.NominationGiverNominatorsListTotalsMapper() ) );
