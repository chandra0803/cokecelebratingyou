...
public class CallPrcChallengePointProgressReportExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_CP_PROGRESS_EXTRACT";

  public CallPrcChallengePointProgressReportExtract( DataSource ds )
  {
    ...
    declareParameter( new SqlOutParameter( "p_out_result_set", OracleTypes.CURSOR, new CallPrcChallengePointProgressReportExtract.DataMapper() ) );
  }
