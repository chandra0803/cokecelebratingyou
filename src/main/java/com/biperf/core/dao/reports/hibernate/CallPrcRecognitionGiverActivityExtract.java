...
public class CallPrcRecognitionGiverActivityExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_RECOGNITION_GIVEN_EXTRACT";

  public CallPrcRecognitionGiverActivityExtract( DataSource ds )
  {
    ...
    declareParameter( new SqlParameter( "p_in_givenType", Types.VARCHAR ) );
    ...
    declareParameter( new SqlOutParameter( "p_out_result_set", OracleTypes.CURSOR, new CallPrcRecognitionGiverActivityExtract.DataMapper() ) );
  ...
  public Map executeProcedure( Map<String, Object> reportParameters )
  {
    ...
    String givenTypeParameter = (String)reportParameters.get( "givenType" );
    if ( GivenType.HAVE.equals( givenTypeParameter ) )
    {
      inParams.put( "p_in_givenType", "have" );
    }
    else if ( GivenType.HAVE_NOT.equals( givenTypeParameter ) )
    {
      inParams.put( "p_in_givenType", "have_not" );
    }
