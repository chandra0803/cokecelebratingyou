 ...
 *
 */
public class CallPrcCPPaxAchieveExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_CP_PAX_ACHIEVE_EXTRACT";

  public CallPrcCPPaxAchieveExtract( DataSource ds )
  {
    ...
    declareParameter( new SqlOutParameter( "p_out_result_set", OracleTypes.CURSOR, new CallPrcCPPaxAchieveExtract.DataMapper() ) );
