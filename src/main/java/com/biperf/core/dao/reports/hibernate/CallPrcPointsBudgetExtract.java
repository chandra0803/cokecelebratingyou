...
public class CallPrcPointsBudgetExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_POINT_BUDGET_SUMM_EXTRACT";

  public CallPrcPointsBudgetExtract( DataSource ds )
  {
