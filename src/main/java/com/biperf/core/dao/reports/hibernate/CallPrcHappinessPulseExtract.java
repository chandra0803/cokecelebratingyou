...
public class CallPrcHappinessPulseExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_HAPPINESS_PULSE_EXTRACT";

  public CallPrcHappinessPulseExtract( DataSource ds )
  {
