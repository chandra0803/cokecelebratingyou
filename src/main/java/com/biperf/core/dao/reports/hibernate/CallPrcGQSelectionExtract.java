...
public class CallPrcGQSelectionExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_GQ_SELECTION_EXTRACT";

  public CallPrcGQSelectionExtract( DataSource ds )
  {
    ...
    declareParameter( new SqlOutParameter( "p_out_result_set", OracleTypes.CURSOR, new CallPrcGQSelectionExtract.DataMapper() ) );
