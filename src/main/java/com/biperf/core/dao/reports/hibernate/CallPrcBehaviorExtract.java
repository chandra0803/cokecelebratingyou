...
public class CallPrcBehaviorExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_BEHAVIOR_EXTRACT";

  public CallPrcBehaviorExtract( DataSource ds )
  {
    ...
    declareParameter( new SqlParameter( "p_giverReceiver", Types.VARCHAR ) );
    ...
    declareParameter( new SqlOutParameter( "p_out_result_set", OracleTypes.CURSOR, new CallPrcBehaviorExtract.DataMapper() ) );
  ...
  public Map executeProcedure( Map<String, Object> reportParameters )
  {
    ...
    inParams.put( "p_giverReceiver", reportParameters.get( "giverReceiver" ) );
