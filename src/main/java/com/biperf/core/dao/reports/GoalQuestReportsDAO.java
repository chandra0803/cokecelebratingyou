 ...
 * $Source: /usr/local/ndscvsroot/products/penta-g/src/java/com/biperf/core/dao/reports/GoalQuestReportsDAO.java,v $
 *
 */
 ...
 * 
 */
public interface GoalQuestReportsDAO extends DAO
{
  /** ApplicationContext beanName */
  public static final String BEAN_NAME = "goalQuestReportsDAO";
