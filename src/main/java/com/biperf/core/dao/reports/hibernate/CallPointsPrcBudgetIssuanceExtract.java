...
public class CallPointsPrcBudgetIssuanceExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "PKG_EXTRACTS.PRC_POINT_BUDGET_ISSU_EXTRACT";

  public CallPointsPrcBudgetIssuanceExtract( DataSource ds )
  {
    ...
    declareParameter( new SqlParameter( "p_in_countryRatio", Types.VARCHAR ) );
