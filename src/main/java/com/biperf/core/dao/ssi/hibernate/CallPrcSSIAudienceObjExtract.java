...
public class CallPrcSSIAudienceObjExtract extends StoredProcedure
{
  private static final String STORED_PROC_NAME = "prc_ssi_contest_extract";

  public CallPrcSSIAudienceObjExtract( DataSource ds )
  {
  ...
  private class SSIContestDataResultSetExtractor implements ResultSetExtractor
  {
    ...
    public List<SSIContestParticipantValueBean> extractData( ResultSet rsSSIContestData ) throws SQLException, DataAccessException
    {
      ...
      while ( rsSSIContestData.next() )
      {
        ...
        participantBean.setObjectivePayoutDescription( withoutFirstLastCharacter( reslutRowArray[4] ) );
        participantBean.setObjectiveAmount( withoutFirstLastCharacter( reslutRowArray[5] ) );
        participantBean.setObjectivePayout( withoutFirstLastCharacter( reslutRowArray[6] ) );
        participantBean.setOtherPayoutDescription( withoutFirstLastCharacter( reslutRowArray[7] ) );
        participantBean.setOtherValue( withoutFirstLastCharacter( reslutRowArray[8] ) );
        participantBean.setBonusForEvery( withoutFirstLastCharacter( reslutRowArray[9] ) );
        participantBean.setBonusPayout( withoutFirstLastCharacter( reslutRowArray[10] ) );
        participantBean.setBonusPayoutCap( withoutFirstLastCharacter( reslutRowArray[11] ) );
