...
/**
 * 
 * CallPrcSSIContestCreatorExtractData.
 * 
 * @author kandhi
 * @since Feb 18, 2015
 * @version 1.0
 */
public class CallPrcSSIContestCreatorExtractData extends StoredProcedure
{
  private static final String SSI_EXPORT_PROC_NAME = "Pkg_ssi_contest_data.prc_ssi_contest_export";

  public CallPrcSSIContestCreatorExtractData( DataSource ds )
  {
  ...
  public Map<String, Object> executeProcedure( Map<String, Object> inParameters )
  {
    ...
    inParams.put( "p_in_locale", inParameters.get( "userLocale" ) );
