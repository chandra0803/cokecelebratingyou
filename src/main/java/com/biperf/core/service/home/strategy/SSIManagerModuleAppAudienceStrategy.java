...
public class SSIManagerModuleAppAudienceStrategy extends StandardModuleAppAudienceStrategy implements ModuleAppAudienceStrategy
{
  ...
  {
    return ssiContestParticipantService.isPaxInContestManagerAudience( participant.getId() );
  }
