...
public class ShopMerchandiseModuleAppAudienceStrategy extends AbstractModuleAppAudienceStrategy implements ModuleAppAudienceStrategy
{
  @Override
    ...
    if ( participant.isParticipant() )
    {
      ...
      if ( programId != null )
      {
        ...
        if ( rewardsList != null )
        {
          ...
          {
            if ( "merchandise".equalsIgnoreCase( rewards.getType() ) )
            {
              return true;
            }
          }
