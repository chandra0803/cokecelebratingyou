...
public class ClaimModuleAppAudienceStrategy extends AbstractModuleAppAudienceStrategy implements ModuleAppAudienceStrategy
{
  @Override
  public boolean isUserInAudience( Participant participant, FilterAppSetup filter, Map<String, Object> parameterMap )
  {
    ...
    {
      if ( promotionMenuBean.getPromotion().isProductClaimPromotion() && promotionMenuBean.isCanSubmit() )
      {
        return true;
      }
    }
