...
public class StringUtil
{
  ...
  public Map<String, String> toMap( String str, String elementSeparator, String keyValueSeparator, Map<String, String> map )
  {
    ...
    result = map == null ? new Hashtable<String, String>() : map;
   ...
   */
  /*
   * public Properties asProperties( String str ) { return this.toProperties( str, null ) ; } //
   * asProperties()
   */
  // -------------------------------------------------------------------------
  /**
   ...
   * properties == null ) ? new Properties() : properties ; return (Properties)this.toMap( str,
   * null, null, props ) ; } // toProperties()
   */
  // -------------------------------------------------------------------------
  // =========================================================================
  ...
  public static String convertStringArrayToCommaString( String[] inputValue )
  {
    String returnCommaString = "";
    for ( int i = 0; i < inputValue.length; i++ )
    {
      if ( i == 0 )
      {
        returnCommaString = inputValue[i];
      }
    ...
    return returnCommaString;
  }

  public static String convertStringArrayToCommaStringNewLine( String[] inputValue )
  {
    String returnCommaString = "";
    for ( int i = 0; i < inputValue.length; i++ )
    {
      ...
      {
        returnCommaString += ",<br/>" + inputValue[i];
      }
    }
    return returnCommaString;
  }
  ...
  public static String convertArrayToINQueryString( String[] inputStringArray )
  {
    String returnString = "";
    for ( int i = 0; i < inputStringArray.length; i++ )
    {
      ...
      else if ( i == inputStringArray.length )
      {
        returnString += "'," + inputStringArray[i] + "'";
      }
  ...
  public static String removeLastOccuranceOf( String sourceStr, String find, String replaceWith )
  {
    return sourceStr.substring( 0, sourceStr.lastIndexOf( find ) ) + replaceWith + sourceStr.substring( sourceStr.lastIndexOf( find ) + 1 );
  }
