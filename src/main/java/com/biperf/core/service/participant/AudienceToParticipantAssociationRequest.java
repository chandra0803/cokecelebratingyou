/*
 * $Source: /usr/local/ndscvsroot/products/beacon/src/java/com/biperf/core/service/participant/AudienceToParticipantAssociationRequest.java,v $
 ...
 *
 */
public class AudienceToParticipantAssociationRequest extends BaseAssociationRequest
{
  ...
  {
    Audience audience = (Audience)domainObject;
