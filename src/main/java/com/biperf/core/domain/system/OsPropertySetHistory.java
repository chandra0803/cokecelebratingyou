...
public class OsPropertySetHistory extends BaseDomain implements Serializable
{
  ...
  {
    if ( ! ( obj instanceof OsPropertySetHistory ) )
    {
      return false;
    }

    OsPropertySetHistory item = (OsPropertySetHistory)obj;
