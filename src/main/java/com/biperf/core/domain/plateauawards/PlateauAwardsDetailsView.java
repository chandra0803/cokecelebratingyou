...
public class PlateauAwardsDetailsView
{
  // This is for future use to keep additional messages
  private String[] messages = {};
  private List<PlateauAwardsDetailBean> promotions;
  ...
  public List<PlateauAwardsDetailBean> getPromotions()
  {
    return promotions;
  }

  public void setPromotions( List<PlateauAwardsDetailBean> promotions )
  {
