 ...
 * $Source: /usr/local/ndscvsroot/products/beacon/src/java/com/biperf/core/domain/process/ProcessRole.java,v $
 */
 ...
 *
 */
public abstract class ProcessRole extends BaseDomain
{
  ...
  {
    ProcessRole processRole = (ProcessRole)obj;

    boolean equals = false;

    equals = process.equals( processRole.getProcess() );

    if ( equals )
    {
      equals = role.equals( processRole.getRole() );
    }
  ...
  public int hashCode()
  {
    ...
    hashCode += getProcess() != null ? getProcess().hashCode() : 13;
    hashCode += getRole() != null ? getRole().hashCode() : 17;
  ...
  public String toString()
  {
    ...
    sb.append( "ProcessRole [" );
    sb.append( "{id=" + super.getId() + "}, " );
    sb.append( "{process.id =" + this.getProcess().getId() + "}, " );
    sb.append( "{role.id=" + this.getRole().getId() + "}" );
    sb.append( "]" );
