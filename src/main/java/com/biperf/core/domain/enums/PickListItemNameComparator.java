 ...
 * $Source: /usr/local/ndscvsroot/products/beacon/src/java/com/biperf/core/domain/enums/PickListItemNameComparator.java,v $
 *
 */
 ...
 *
 */
public class PickListItemNameComparator implements Comparator
{
  /**
