...
public class MerchOrderBillCode extends BaseDomain
{
  @JsonBackReference
  ...
  public boolean equals( Object object )
  {
    ...
    if ( ! ( object instanceof MerchOrderBillCode ) )
    {
      return false;
    }

    final MerchOrderBillCode merchOrderBillCode = (MerchOrderBillCode)object;

    if ( getMerchOrder() != null && !getMerchOrder().equals( merchOrderBillCode.getMerchOrder() ) )
    {
      return false;
    }
  ...
  public int hashCode()
  {
    return getMerchOrder() == null ? 0 : getMerchOrder().hashCode();
  }
