...
public class PaxCPLevelImportRecord extends ImportRecord
{
  // ---------------------------------------------------------------------------
  // Fields
  // ---------------------------------------------------------------------------
  ...
  /**
   * The name of the cp level the user (participant) will be assigned.
   */
  ...
  public boolean equals( Object object )
  {
    ...
    if ( ! ( object instanceof PaxCPLevelImportRecord ) )
    {
      return false;
    }

    PaxCPLevelImportRecord importRecord = (PaxCPLevelImportRecord)object;
  ...
  public String toString()
  {
    ...
    buf.append( "PaxCPLevelImportRecord [" );
  ...
  public void setLevelName( String goalLevelName )
  {
    this.levelName = goalLevelName;
  }
}
