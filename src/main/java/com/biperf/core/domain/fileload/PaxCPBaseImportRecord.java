...
public class PaxCPBaseImportRecord extends ImportRecord
{
  // ---------------------------------------------------------------------------
  // Fields
  // ---------------------------------------------------------------------------
  ...
  public boolean equals( Object object )
  {
    ...
    if ( ! ( object instanceof PaxCPBaseImportRecord ) )
    {
      return false;
    }

    PaxCPBaseImportRecord importRecord = (PaxCPBaseImportRecord)object;
  ...
  public String toString()
  {
    ...
    buf.append( "PaxCPBaseImportRecord [" );
