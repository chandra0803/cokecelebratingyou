 ...
 * $Source: /usr/local/ndscvsroot/products/penta-g/src/java/com/biperf/core/domain/enums/PickListItemNameComparator.java,v $
 *
 */
...
/**
 * ParticipantNameComparator <p/> <b>Change History:</b><br>
 * <table border="1">
 * <tr>
 * <th>Author</th>
 * <th>Date</th>
...
public class ParticipantNameComparator implements Comparator
{
  ...
  public int compare( Object o1, Object o2 )
  {
    ...
    return ( (Comparable)item1.getNameLFMNoComma().toUpperCase() ).compareTo( item2.getNameLFMNoComma().toUpperCase() );
  }
}
