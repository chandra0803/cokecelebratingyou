 ...
 * $Source: /usr/local/ndscvsroot/products/beacon/src/java/com/biperf/core/domain/user/UserNameComparator.java,v $
 *
 */
...
public class UserNameComparator implements Comparator
{
  ...
  public int compare( Object o1, Object o2 )
  {
    ...
    return ( (Comparable)user1.getNameLFMNoComma() ).compareTo( user2.getNameLFMNoComma() );
  }
}
