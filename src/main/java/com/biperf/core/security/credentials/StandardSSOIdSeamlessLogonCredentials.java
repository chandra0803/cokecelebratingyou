...
/**
 * StandardSSOIdSeamlessLogonCredentials.
 * <p>
 ...
 * 
 */
public class StandardSSOIdSeamlessLogonCredentials implements Serializable, SeamLessLogonCredentials
{
  private static final Log logger = LogFactory.getLog( StandardSSOIdSeamlessLogonCredentials.class );
   ...
   *
   */
  public StandardSSOIdSeamlessLogonCredentials()
  {
    //
  }
  ...
  private boolean isUserValid()
  {
    ...
    List<Participant> participants = getParticipantService().getUserBySSOId( uniqueId );
    ...
    if ( getSystemVariableService().getPropertyByName( SystemVariableService.SSO_DETAILED_LOGGING_ON ).getBooleanVal() )
    {
      logger.error( "Checking if can find Participant by sso id. validIndentifier=" + validIndentifier + " uniqueId=" + uniqueId );
    }
  ...
  public String getDecryptedValue( String encryptedValue )
  {
    ...
    if ( getSystemVariableService().getPropertyByName( SystemVariableService.SSO_DETAILED_LOGGING_ON ).getBooleanVal() )
    {
      logger.error( "decryptedValue=" + decryptedValue );
    }
