...
/*exported ApprovalsModel, ApprovalsCollection, PaxSearchReactCollection */
/*global
console,
$,
G5,
Backbone,
ApprovalsModel,
PaxSearchReactCollection,
PaxSearchReactModel,
callback,
ApprovalsCollection:true
*/
PaxSearchReactCollection = Backbone.Collection.extend( {

    model: PaxSearchReactModel,

    initialize: function ( opts ) {
        console.log( '[INFO] PaxSearchReactCollection: Approval Collection initialized', this );
    ...
    loadNominations: function ( dateStart, dateEnd, nominationType, status, promotionName ) {
        //var thisCollection = this,
            //params = {};
        console.log( '[INFO] PaxSearchReactCollection: loadNominations started' );
    },
    ...
    loadClaimDetailData: function () {
        ...
        console.log( '[INFO] PaxSearchReactCollection: loadClaimDetailData started' );
        $.ajax( {
            dataType: 'g5json',
            type: 'POST',
            url: G5.props.URL_JSON_APPROVALS0_LOAD_CLAIM_DETAIL_DATA,
            data: params,
            success: function ( serverResp ) {
                //regular .ajax json object response
                var data = serverResp.data,
                    claims;
                console.log( '[INFO] PaxSearchReactCollection: loadClaimDetailData ajax call successfully returned this JSON object: ', data );
                ...
                if ( claims.length > 0 ) {
                    ...
                    console.log( '[INFO] PaxSearchReactCollection: loadClaimDetailData ajax call returned no data, no claims to load: ', data );
                }
            }
        } ).fail( function ( jqXHR, textStatus ) {
            console.log( '[INFO] PaxCollection: loadClaimDetailData Request failed: ' + textStatus );
        } );
    },
    ...
    translateData: function( $attr ) {
        ...
        $.ajax( {
            ...
            success: function( serverResp ) {
                ...
                console.log( '[INFO] PublicPaxModel - PaxTranslated' );
