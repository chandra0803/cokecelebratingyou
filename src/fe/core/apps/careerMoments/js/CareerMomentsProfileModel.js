/*exported CareerMomentsProfileModel*/
/*global
JSON,
CareerMomentsProfileModel:true
*/
CareerMomentsProfileModel = Backbone.Model.extend( {
    ...
    fetchComments: function() {
        ...
        $.ajax( {
            ...
            success: function( serverResp ) {
                ...
                //console.log('[INFO] CareerMomentsProfileModel.fetchComments - resp: ', serverResp);
    ...
    saveComment: function( comment ) {
        ...
        $.ajax( {
            ...
            success: function( serverResp ) {
                ...
                //console.log('[INFO] CareerMomentsProfileModel.saveComment - resp: ', serverResp);
