/*exported ReportsChangeFiltersPopoverView*/
...
ReportsChangeFiltersPopoverView = Backbone.View.extend( {
    ...
    initialize: function( opts ) {
        ...
        this.$trigger.qtip( {
            ...
            style: {
                classes: 'ui-tooltip-shadow ui-tooltip-light reportsChangeFiltersPopover modal modal-stack',
                tip: {
                    corner: false
                }
            },
            events: {
                show: function() {that.doShown();}
            }
    ...
    doShown: function() {
        ...
        $( '.reportsChangeFiltersPopover' ).before( '<div class="modal-backdrop fauxdrop"></div>' );
    ...
    render: function() {
        ...
        if ( $( '.paxSearchStartView' ).length > 0 ) {
