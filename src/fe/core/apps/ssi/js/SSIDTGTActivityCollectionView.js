/* exported SSIDTGTActivityCollectionView */
/*global
console,
$,
_,
...
SSIDTGTActivityCollectionView = Backbone.View.extend( {
    ...
    events: {
        ...
        'keydown .activityDetailEarn input': 'noDecimal',
        'keydown .activityDetailIndPayCap input': 'noDecimal',
        'keydown .bonusPayoutCapInput': 'noDecimal',
        'keydown .contestGoalInput': 'noDecimal',
