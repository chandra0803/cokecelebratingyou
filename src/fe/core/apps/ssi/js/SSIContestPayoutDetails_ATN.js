/*exported SSIContestPayoutDetails_ATN */
/*global
console,
$,
_,
...
SSIContestPayoutDetails_ATN = PageView.extend( {
    ...
    createHistoryTable: function () {
        ...
        keys = [ 'totalActivity', 'totalPayoutAmount', 'sortedOn', 'sortedBy', 'payoutType' ];
    ...
    addDenyPopover: function( e ) {
        ...
        if ( !$tar.data( 'qtip' ) ) {
            this.attachPopover( $tar, $cont, 'top right', 'bottom center' );
        }
    },
    ...
    attachPopover: function( $trig, cont, myPos, atPos ) {
        $trig.qtip( {
            ...
            style: {
                classes: 'ui-tooltip-shadow ui-tooltip-light ssiContestPayoutDetailsATNPopover',
                tip: {
                    corner: true,
                    width: 20,
                    height: 10
