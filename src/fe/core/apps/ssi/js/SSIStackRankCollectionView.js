/* exported SSIStackRankCollectionView */
/*global
console,
$,
_,
...
SSIStackRankCollectionView = SSISharedHelpersView.extend( {
    ...
    render: function () {
        ...
        // checks for an existing render and only uses the spincover when true
        var coverWhileSpinning = this.settings.get( 'rendered' ) === true;

        G5.util.showSpin( this.$el, { cover: coverWhileSpinning } );
