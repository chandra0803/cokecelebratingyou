/* exported SSISortableTableCollection */
/*global
_,
$,
console,
...
SSISortableTableCollection = Backbone.Collection.extend( {
    ...
    initialize: function () {
        ...
        this._sortableColumns = {
            ...
            'updatedBy': function( json ) {
                return _.sortBy( json, function ( rowData ) {
                    return rowData.updatedBy.toLowerCase();
                } ).reverse();
            },
            'updatedOn': function( json ) {
                return _.sortBy( json, function ( rowData ) {
                    return new Date( rowData.updatedOn ).getTime();
                } );
            },
