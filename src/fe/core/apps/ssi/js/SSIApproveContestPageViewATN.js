/*exported SSIApproveContestPageViewATN */
/*global
G5,
Backbone,
$,
...
SSIApproveContestPageViewATN = PageView.extend( {
    ...
    createHistoryTable: function () {
        ...
        keys = [ 'payoutType', 'totalParticipantsCount', 'totalActivity',
    ...
    addDenyPopover: function( e ) {
        ...
        if ( !$tar.data( 'qtip' ) ) {
            this.attachPopover( $tar, $cont, 'bottom right', 'top center', onHide );
        }
    },
    ...
    attachPopover: function( $trig, cont, myPos, atPos, hideCallback ) {
        $trig.qtip( {
            ...
            style: {
                classes: 'ui-tooltip-shadow ui-tooltip-light ssiApproveContestATNPagePopover',
                tip: {
                    corner: true,
                    width: 20,
                    height: 10
        ...
        $trig.data( 'qtip_error', $trig.data( 'qtip' ) ).removeData( 'qtip' );
    },
