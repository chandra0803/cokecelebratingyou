/*exported SSIContestEditTabPayoutsView_sr */
/*global
$,
_,
Backbone,
...
SSIContestEditTabPayoutsView_sr = Backbone.View.extend( {
    ...
    events: {
        ...
        'keydown .payoutAmount': 'noDecimal',
    ...
    ***************************************************** */
    ...
    updateTotalsAndMaxes: function() {
        ...
        rc.each( function( r ) {
            var pay = parseInt( r.get( 'payoutAmount' ) ); // wholenums
            maxPay += pay;
        } );
