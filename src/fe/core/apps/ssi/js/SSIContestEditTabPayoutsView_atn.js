/*exported SSIContestEditTabPayoutsView_atn */
/*global
$,
_,
Backbone,
...
SSIContestEditTabPayoutsView_atn = Backbone.View.extend( {
    ...
    events: {
        ...
        'keydown .textInputCell .atnPayoutInput': 'noDecimal',
    ...
    ***************************************************** */
    ...
    initPaxTable: function() {
        ...
        this.paxPaginatedView = new ParticipantPaginatedView( {
            ...
            validationTypeByKey: function( k ) {
                ...
                } else if ( k == 'objectivePayout' ) { // payouts
                    return { type: 'natural', precision: 0, allowNegs: false };
                } else { // string fields ( activity decription and payout description )
                    return null;
                }
            },
    ...
    initTextEditor: function() {
        ...
        // NOTE: this shouldn't be a rich text editor,
        // but changing it to a plain textarea with spellcheck and character counting on the day we want to cut the release is silly
        // so I'm going to move the spellcheck button to the right with CSS and we should fix this eventually
