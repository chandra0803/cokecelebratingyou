/* exported SSIUpdateResultsPageView */
/*global
$,
_,
G5,
...
SSIUpdateResultsPageView = PageView.extend( {
    ...
    saveForm: function( e ) {
        ...
        if( submitMethod == 'ssiEnterActivityForm' ) {
            data = {
                url: this.url,
                method: 'save',
        ...
        else if( submitMethod == 'ssiUploadSSForm' ) {
    ...
    fileUpload: function() {
        ...
        $input.fileupload( {
            ...
            submit: function( e, data ) {
                data.formData = {
                    method: 'save',
                    saveAndSendProgressUpdate: that.progressUpdate
                };
            },
