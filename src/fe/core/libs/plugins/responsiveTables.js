    ...
    $.fn.responsiveTable = function(opts) {
        return this.each(function() {
            ...
            function _makeResponsive() {
                ...
                that.$cloneLeft.find('.invisible').removeClass('invisible');
                ...
                _.each(settings.pinLeft.sort(), function(index) {
                    that.$cloneLeft.data('rT').width += that.$table.find('tr:eq(0) > :nth-child('+(index+1)+')').outerWidth();

                    that.$cloneLeft.find('th:nth-child('+(index+1)+'), td:nth-child('+(index+1)+')').addClass('visible');
                    that.$table.find('th:nth-child('+(index+1)+'), td:nth-child('+(index+1)+')').each(function() {
                        if( $(this).offset().left <= that.$table.offset().left ) {
            ...
            function _makeNormal() {
                ...
                that.$table.find('.invisible').removeClass('invisible');
