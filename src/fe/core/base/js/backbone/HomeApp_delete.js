...
HomeApp = Backbone.View.extend( {
    ...
    initialize: function( opts ) {
        ...
        G5._globalEvents.on( 'globalNavFilterChanged', this.globalNavFilterChanged, this );
        // call to set initial filter if router triggers before loaded
        this.globalNavFilterChanged( G5.props.currentFilter );
    },

    globalNavFilterChanged: function( filter ) {
