/*exported ParticipantSearchView */
/*global
TemplateManager,
...
ParticipantSearchView = Backbone.View.extend( {
    ...
    renderParticipants: function( msg, singleId ) {
        ...
        this.$participantTable.find( '[data-sort]' )
            .removeClass( 'asc icon-arrow-1-up desc icon-arrow-1-down' ).addClass( 'icon-arrow-1-down' )
            .closest( 'th' ).removeClass( 'sorted' );
        this.$participantTable.find( '[data-sort=' + this.model.sortCol + ']' )
            .addClass( this.model.sortAsc ? 'asc iicon-arrow-1-up' : 'desc icon-arrow-1-down' )
