/*exported ParticipantPopoverView */
/*global
TemplateManager,
Backbone,
RecognitionEzView,
...
ParticipantPopoverView = Backbone.View.extend( {
    ...
    openPublicProfile: function( event ) {
        ...
        var //that = this,
            ...
            //isModule = $tipTarget.closest( '.launchModule' ).length > 0,
            ...
            // changing this for now. The popover view will always open public profile in a sheet
            // keep an eye out for exceptions to add some logic here
            isOpenFull = false;
