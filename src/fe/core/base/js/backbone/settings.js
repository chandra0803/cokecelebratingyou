...
G5._globalEvents = _.extend( {}, Backbone.Events );
G5.props.CURRENT_ROUTE = null;

// convenient time stamp for profiling
G5.time = new Date();

G5.props.CACHE_MODULE_ARRANGEMENTS = true;
G5.props.DEFAULT_FILTER = 'recognition';
...
G5.props.URL_JHTML_STYLE = '../../skins/default/css/jhtmlArea.css'; //path for sticking in the jhtml css

G5.props.URL_START_RECOGNITION = 'layout.html?tplPath=apps/programSelect/tpl/&tpl=programSelectPageView.html';
...
G5.props.URL_JSON_PARTICIPANT_PROFILE_ALERTS = G5.props.URL_ROOT + 'ajax/participantProfileAlerts.json';//current active user's alerts
G5.props.CHECK_FOR_NOMINATION_WINNER = false; // set to true to make the call to the following URL
G5.props.URL_JSON_PARTICIPANT_PROFILE_NOMINATION_WINNER_MODAL = G5.props.URL_ROOT + 'ajax/participantProfileNominationWinnerModal.json'; // URL to check if the current user is a winner

G5.props.URL_JSON_SAVED_PARTICIPANT_GROUPS = G5.props.URL_ROOT + 'ajax/savedParticipantSearchGroups.json';
...
G5.props.URL_JSON_PARTICIPANT_TOKENIZED_SEARCH_AUTOCOMPLETE = G5.props.URL_ROOT + 'ajax/paxgenerator/participantTokenizedsearch.json'; //autocomplete data for tokenized search
...
G5.props.URL_JSON_GLOBAL_SEARCH_AUTOCOMPLETE = G5.props.URL_ROOT + 'ajax/global_results.json';
G5.props.URL_JSON_GLOBAL_SEARCH_FILTERS = G5.props.URL_ROOT + 'ajax/paxFilters.json';

G5.props.URL_JSON_PUBLIC_RECOGNITION = G5.props.URL_ROOT + 'ajax/publicRecognition_recommended.json';//pub rec items
...
G5.props.REPORTS_MAX_FAVORITES = 5;
...
// Custom for coco cola wip#58122
G5.props.URL_JSON_NOMINATION_RECIPIENT_SELECTION = G5.props.URL_ROOT+'ajax/recipientSelection.json';
//ezRecognition
...
G5.props.URL_JSON_CHEERS_INFO = G5.props.URL_ROOT + 'ajax/cheersInfo.json';
G5.props.URL_JSON_CHEERS_SEND_RECOGNITION = G5.props.URL_ROOT + 'ajax/cheersRecognitionSuccess.html';

// Bunchball Customization - wip-62444
G5.props.URL_BUNCHBALL_WIDGET = G5.props.URL_ROOT + '../apps/bunchBall/tpl/bunchWidget.html';
...
//xpromo page JSON
G5.props.URL_JSON_XPROMO = G5.props.URL_ROOT + 'ajax/xpromo.json';
...
G5.props.URL_JSON_PROFILE_PAGE_PERSONAL_INFORMATION_IMAGE_UPLOAD = G5.props.URL_ROOT + 'ajax/profilePagePersonalInformationTabImageUpload.json';
...
// Profile Page GROUPS
G5.props.URL_JSON_GLOBAL_DELETE_GROUP = G5.props.URL_ROOT + 'ajax/dummy.json';
G5.props.URL_JSON_GLOBAL_FETCH_GROUP_BY_ID = G5.props.URL_ROOT + 'ajax/profilePageFetchGroupById.json';
G5.props.URL_JSON_GLOBAL_FETCH_GROUPS = G5.props.URL_ROOT + 'ajax/profilePageFetchGroups.json';
G5.props.URL_JSON_GLOBAL_SAVE_CREATE_GROUP = G5.props.URL_ROOT + 'ajax/profilePageGroupSave.json';
...
//nominations
G5.props.URL_JSON_NOMINATIONS_TABS_DATA = G5.props.URL_ROOT + 'ajax/nominationsTabsData.json';
G5.props.URL_JSON_NOMINATIONS_APPROVALS_TRANSLATE_COMMENT = G5.props.URL_ROOT + 'ajax/nominationApprovalsTranslateComment.json';
G5.props.URL_JSON_NOMINATIONS_PARTICIPANTS = G5.props.URL_ROOT + 'ajax/nominationsParticipantData.json';
G5.props.URL_JSON_NOMINATIONS_CALCULATOR_SEND_INFO = G5.props.URL_ROOT + 'ajax/nominationsCalcSendInfo.json';
G5.props.URL_JSON_NOMINATIONS_CALCULATOR_DATA = G5.props.URL_ROOT + 'ajax/nominationsCalcData.json';
G5.props.URL_JSON_NOMINATIONS_SUBMIT_DATA = G5.props.URL_ROOT + 'ajax/nominationsSubmitData.json';
G5.props.URL_JSON_NOMINATIONS_EDIT_SAVE = G5.props.URL_ROOT + 'ajax/nominationsEditSave.json';
G5.props.URL_JSON_NOMINATIONS_UPLOAD_DOC = G5.props.URL_ROOT + 'ajax/nominationsUploadDoc.json';
G5.props.URL_JSON_NOMINATIONS_UPLOAD_DOC_REMOVE = G5.props.URL_ROOT + 'ajax/nominationsUploadDocRemove.json';
G5.props.URL_JSON_NOMINATIONS_LIST = G5.props.URL_ROOT + 'ajax/nominationsList.json';
G5.props.URL_JSON_NOMINATIONS_INPROGRESS_COUNT = G5.props.URL_ROOT + 'ajax/nominationsInprogress.json';
G5.props.URL_JSON_NOMINATIONS_INPROGRESS_TABLE = G5.props.URL_ROOT + 'ajax/nominationsInprogressTableList.json';
G5.props.URL_JSON_NOMINATIONS_INPROGRESS_LIST_REMOVE = G5.props.URL_ROOT + 'ajax/nominationsInprogressListRemove.json';
G5.props.URL_JSON_NOMINATIONS_REMOVE = G5.props.URL_ROOT + 'ajax/nominationsInProgressRemoveResponse.json';
G5.props.URL_JSON_NOMINATIONS_PENDING_APPROVAL = G5.props.URL_ROOT + 'ajax/nominationsPendingApproval.json';
G5.props.URL_JSON_NOMINATIONS_WINNERS_LIST = G5.props.URL_ROOT + 'ajax/nominationsWinnersList.json';
G5.props.URL_JSON_NOMINATIONS_WINNERS_DETAIL = G5.props.URL_ROOT + 'ajax/nominationsWinnersDetail.json';
G5.props.URL_JSON_NOMINATIONS_WINNERS_DETAIL_TRANSLATE_COMMENT = G5.props.URL_ROOT + 'ajax/nominationsWinnersDetailTranslateComment.json';
G5.props.URL_JSON_NOMINATIONS_SEARCH_AUTOCOMPLETE = G5.props.URL_ROOT + 'ajax/nominationWinnersSearch_autocomp_firstName.json';   //participant search results
G5.props.URL_JSON_NOMINATIONS_APPROVAL_PROMO_LIST = G5.props.URL_ROOT + 'ajax/nominationsApprovalPromoList.json';
G5.props.URL_JSON_NOMINATIONS_APPROVAL_PAGE_DATA = G5.props.URL_ROOT + 'ajax/nominationsApprovalPageData.json';
G5.props.URL_JSON_NOMINATIONS_SEND_BUDGET_REQUEST = G5.props.URL_ROOT + 'ajax/nominationsApprovalBudgetRequest.json';
G5.props.URL_JSON_NOMINATIONS_APPROVAL_SEND_MESSAGE = G5.props.URL_ROOT + 'ajax/nominationsApprovalSendMessage.json';
G5.props.URL_JSON_NOMINATIONS_APPROVAL_TABLE_DATA = G5.props.URL_ROOT + 'ajax/nominationsApprovalTableData.json';
G5.props.URL_JSON_NOMINATIONS_MORE_INFO = G5.props.URL_ROOT + 'ajax/nominationsMoreInfo.json';
G5.props.URL_JSON_NOMINATIONS_MORE_INFO_SUBMIT = G5.props.URL_ROOT + 'ajax/nominationsMoreInfo.json';
G5.props.URL_JSON_NOMINATIONS_MORE_INFO_UPLOAD = G5.props.URL_ROOT + 'ajax/nomsMoreInfoUploadDoc.json';
G5.props.URL_JSON_NOMINATIONS_MORE_INFO_TRANSLATE_COMMENT = G5.props.URL_ROOT + 'ajax/nominationsMoreInfoTranslateComment.json';
G5.props.URL_JSON_NOMINATIONS_MY_LIST_DATA = G5.props.URL_ROOT + 'ajax/nominationsMyList.json';
G5.props.URL_JSON_NOMINATIONS_CERTIFICATE_DATA = G5.props.URL_ROOT + 'ajax/nomsCertInfo.json';
G5.props.URL_PDF_SERVICE = 'https://apipprd.biworldwide.com/v1/utility/pdf';
G5.props.URL_CERT_TPL_ROOT = G5.props.URL_ROOT + 'tpl/';
// Custom Form Elements
G5.props.URL_JSON_CUSTOM_FORM_ELEMENTS = G5.props.URL_ROOT + 'ajax/customElementsData.json';
G5.props.URL_GET_CERT_IMAGES = G5.props.URL_ROOT + 'ajax/getCertImages.json';
G5.props.URL_JSON_NOMINATIONS_CUMULATIVE = G5.props.URL_ROOT + 'ajax/nominationsApprovalCumulativeInfo.json';
...
G5.props.URL_DECLINE_URL = G5.props.URL_ROOT + 'layout.html?tplPath=base/tpl/&tpl=loginPage.html';
...
//hero
G5.props.URL_JSON_HERO_BANNER = G5.props.URL_ROOT + 'ajax/heroBanner.json';
...
G5.props.URL_JSON_SSI_PAX_UPLOAD_DOCUMENT = G5.props.URL_ROOT + 'ajax/ssiCreatePaxUploadSave.json';

//WorkHappier
G5.props.URL_JSON_WORK_HAPPIER_PAST_RESULTS = G5.props.URL_ROOT + 'ajax/workHappierPastResults.json';

//Program Select
G5.props.URL_JSON_PROGRAM_SELECT_DATA = G5.props.URL_ROOT + 'ajax/programSelectPromoList.json';

// Customization for Celebrating You - WIP#61381 starts
// Career Moments
G5.props.URL_JSON_CAREERMOMENTS_RIBBON_DATA = G5.props.URL_ROOT + 'ajax/careerMomentsRibbonData.json';
G5.props.URL_JSON_CAREERMOMENTS_DATA = G5.props.URL_ROOT + '../apps/careerMoments/tpl/careerMomentsSet.html';
G5.props.URL_JSON_CAREERMOMENTS_ACTIVITY_FEED = G5.props.URL_ROOT + 'ajax/careerMomentsCommentsData.json';
G5.props.URL_JSON_CAREERMOMENTS_POST_COMMENT = G5.props.URL_ROOT + 'ajax/purlContributeCommentPost.json';
G5.props.URL_JSON_CAREERMOMENTS_SAVE_COMMENT = G5.props.URL_ROOT + 'ajax/careerMomentsSaveComment.json';
G5.props.URL_JSON_CAREERMOMENTS_UPLOAD_PHOTO = G5.props.URL_ROOT + 'ajax/purlContributeCommentPhotoUpload.json';
G5.props.URL_JSON_CAREERMOMENTS_SAVE_LIKE = G5.props.URL_ROOT + 'ajax/careerMomentsSaveLike.json';
G5.props.URL_JSON_CAREERMOMENTS_SAVE_UNLIKE = G5.props.URL_ROOT + 'ajax/careerMomentsSaveUnLike.json';
G5.props.URL_JSON_CAREERMOMENTS_IAMSAVE_LIKE = G5.props.URL_ROOT + 'ajax/careerMomentsSaveLike.json';
G5.props.URL_JSON_CAREERMOMENTS_IAMSAVE_UNLIKE = G5.props.URL_ROOT + 'ajax/careerMomentsSaveUnLike.json';
G5.props.URL_JSON_CAREERMOMENTS_SEARCH_RESULTS = G5.props.URL_ROOT + '../apps/careerMoments/tpl/careerMomentsSet.html';
G5.props.URL_JSON_CAREERMOMENTS_SEARCH_AUTOCOMPLETE = G5.props.URL_ROOT + 'ajax/participantSearch_autocomp_firstName.json';//participant search results

// Customization for Celebrating You - WIP#61381 Ends
...
G5.props.richTextEditor = {
    ...
    loaded: function ( options ) {
        ...
        handleParagraphCleanup = function() {
            ...
            str = str.match( /^(<p>|<p class)/gi ) ? str : '<p><p>' + str;     // if the string doesn't start with a <p> tag, do so

            str = str.replace( /<\/div><div>|<(|\/)div>/gi, '</p>' )                   // anywhere a div ends and restarts another one add a break tag, turn every remaining <div> tag into a <br> tag
                     .replace( /&lt;/g, '<' ) // convert &lt; to <                                   
                     .replace( /&gt;/g, '>' ) // convert &gt; to >
                     .replace( /<xml>[\s\S]*?<\/xml>|<style>[\s\S]*?<\/style>|class=".*?"|class=[a-z0-9]+|style=('|")[\s\S]*?\1|<!--[\s\S]*?-->/gi, '') // Terminate junk characters which comes inside <!-- -->  
                     .replace( /(<p>){3,}|<div><p>|<div>/gi, '</p>' )     // turn fake full paragraph returns into proper ones
                     ...
                     .replace( /<(|\/)(div|p)><(o|u)l>/gi, '</p><$3l>' )             // anywhere a UL|OL follows a </div>, make it follow a </p> instead
                     ...
                     str = str.match( /<\/(p|ol|ul)>$/gi ) ? str : str + '</p><br></p><br>';     // if the string doesn't end with a P|OL|UL, end with a </p>
        ...
        */
        ...
        $tb.find( 'li' ).not( '.separator' ).addClass( 'btn btn-icon btn-small' );
        $tb.find( 'li.separator' )
            .prev().addClass( 'sep-before' )
            .end().next().addClass( 'sep-after' );
        $tb.find( '.bold' ).addClass( 'icon-bold' );
        $tb.find( '.italic' ).addClass( 'icon-text-italic' );
        $tb.find( '.underline' ).addClass( 'icon-underline' );
        $tb.find( '.orderedlist' ).addClass( 'icon-list-numbers' );
        $tb.find( '.unorderedlist' ).addClass( 'icon-list-bullets' );
        $tb.find( '.checkSpelling' ).addClass( 'icon-check' );
        $tb.find( '.removeFormat' ).addClass( 'icon-close' );
        $tb.find( '.html' ).addClass( 'icon-wrench-1' );
        ...
        if( !$tb.find( '.langs' ).length ) {
            ...
            var langs = '<ul class="langs dropdown-menu"><li class="check"><a>' + $tb.find( '.checkSpelling' ).attr( 'title' ) + '</a></li>';
            ...
            $.each( G5.props.spellCheckerLocalesToUse, function( i, v ) {
                if( G5.props.spellCheckerLocalization[ v ] ) {
                    langs += '<li class="lang ' + v + '" data-lang="' + v + '"><a href="#">' + G5.props.spellCheckerLocalization[ v ].menu + '</a></li>';
                }
            } );
...
Handlebars.registerHelper( 'ueq', function( a, b, options ) {
      if ( !options || typeof options.fn !== 'function' ) { return a !== b; }
      return options[ a !== b ? 'fn' : 'inverse' ]( this );

} );
//is JSON value greater than or equal to something
//Usage in template
//{{#gte count 1 }}
//<button class="orderer">save order</button>
//{{else}}
//<span>foo</span>
//{{/gte}}
/*Handlebars.registerHelper('gte', function(val, val2, block) {
...
//is JSON value less than to something
//Usage in template
//{{#lt count 1 }}
//<button class="orderer">save order</button>
//{{else}}
//<span>foo</span>
//{{/lt}}
/*Handlebars.registerHelper('lt', function(val, val2, block) {
...
//ifnotor either value is true
//adapated from: https://github.com/assemble/handlebars-helpers/blob/master/lib/helpers/helpers-comparisons.js
//Usage in template
// {{#ifnotor valueOne valueTwo}}
// <some code>
// {{else}}
// <some default code>
// {{/ifnotor}}
Handlebars.registerHelper( 'ifnotor', function( testA, testB, options ) {
    if ( !testA ||  testB ) {
        return options.fn( this );
    } else {
        return options.inverse( this );
...
//if any value in array is true
//adapated from: https://github.com/assemble/handlebars-helpers/blob/master/lib/helpers/helpers-comparisons.js
//Usage in template
// {{ #oror valueOne valueTwo valueThree }}
// <some code>
// {{else}}
// <some default code>
// {{/oror}}
Handlebars.registerHelper( 'oror', function( testA, testB, testC, options ) {
...
//Comparing context value with two possible values
// celebImageUrl is the context value that is checked again null possibilities and empty value
// {{#if3notelse celebImageUrl null "null" ""}}                
// <p>if it matches null</p>
// {{else}}




//  <p>Display the value</p>
//  {{/if3notelse}}
Handlebars.registerHelper( 'if3notelse', function( testA, testB, testC, testD, options ) {
    if ( testA === testB || testA === testC ||  testA === testD ) {
        return options.fn( this );
    } else {
        return options.inverse( this );
    }
...
// Time Stamping the url on image to avoid caching
Handlebars.registerHelper( 'timeStamp', function( item ) {
    if( item ) {
    var src, ts;
...
//Loop counter. Similar to each but adds a position variable for index counting.
/*
{{#iter billCodes}}
<div class="billCodeSelectWrap">
    <label>Bill Code {{position}}:</label>
    <select name="ssiBillCodes[{{index}}]" id="ssiBillCodes[{{index}}]" class="ssiBillCodes" data-model-key="ssiBillCodes" data-index="{{index}}">
        <option value="default" selected>Select Bill Code</option>
        {{#../billCodes}}
        <option value="{{billCode}}">{{billCodeName}}</option>
        {{/../billCodes}}
    </select>
</div>
{{/iter}}
...
Handlebars.registerHelper( 'iterSsi', function ( context, options ) {
    var ret = '';

    for ( var i = 0, j = context.length; i < j; i++ ) {
        ret += options.fn( $.extend( context[ i ], {
            position: i
        } ) );
    }
...
//trim string based on start and end values
//Usage in template
//{{trimString value 0 10}}
...
// the #last helper breaks things other places. Removing until Handlebars is updated and we can use @last
//
// checks to see if element is last in iteration.
// Handlebars.registerHelper('last', function(index, length)
// {
//     if(parseInt(index, 10) == parseInt(length, 10) - 1){
//         return '';
//     } else {
//         return false;
//     }
