    ...
    render: function() {
        ...
        _.each( this.model.models, function( bi, index ) {
            TemplateManager.get( tplName, function( tpl ) {
                ...
                if( typeof tplData.remaining == 'undefined' ) {
                    tplData.remaining = tplData.total - tplData.used;
                }
                // prepare for tip
                //calcBudgRem = tplData.total - tplData.used; Bug 67645
                calcBudgRem = tplData.remaining;
