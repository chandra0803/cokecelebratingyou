...
it ( 'enables the button when username and password are entered when email not unique.', () => {
    const props = {
        ...defaultProps,
        verification: {
            confirmation: {
    ...
    const input2 = tree.find( 'input[name="username"]' );

    input2.simulate( 'change', { target: { name: input2.props().name, value: 'abc' } } );
...
it ( 'shows a error alert when there are error messages.', () => {
    const login = {
        login: {
            ...defaultProps.login,
            messages: [ {
...
it ( 'does not execute submitPass prop when the user presses enter in the password input no password.', () => {
    ...
    tree.setState( { password1: '', disabled: false } );
...
it ( 'does not execute submitPass prop when the user presses enter in the password input when disabled.', () => {
    const props = {
        ...defaultProps,
        submitPass: jest.fn()
    };
...
it ( 'does not execute submitPass prop when the user presses enter in the password input when login id input available but username null.', () => {
    const props = {
        ...defaultProps,
        verification: {
            confirmation: {
    ...
    tree.setState( { password1: 'password', disabled: false, username: '' } );
...
it ( 'executes submitPass prop when the user presses enter in the password input with userID input available and username entered.', () => {
    const props = {
        ...defaultProps,
        verification: {
            confirmation: {
    ...
    tree.setState( { password1: 'password', disabled: false, username: 'asf' } );
